...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">后台权限</font> 
            </div>
         <div style="float:right;">
           
            <a href="<?php echo U('Quanxian/add');?>" class="btn btn-default0 pull-right">新增后台用户</a>
    ...
    input{
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                 <form action="<?php echo U('Admin/Quanxian/add2');?>" method="post">
             <select class="ip"  style="margin-top:10px; margin-left:20px; height:42px; width:120px;" name="sid"> 
            
                      <?php if(is_array($ru)): foreach($ru as $key=>$c): ?><option style="height:23px;" value ="<?php echo ($c["id"]); ?>"><?php echo ($c["title"]); ?></option><?php endforeach; endif; ?>
        
                 </select>
                <input type="text" name="name" class="ip" style="width:250px;position:relative;left:-16px;top: 1px;"  placeholder="Admin/Msg/list"/>
                <input type="text" class="ip" name="title"   style="width:180px; position:relative;left:-25px;top: 1px;"  placeholder="权限名称"/>
                <input type="submit" class="btn btn-primary"  style="width:100px;height:40px;margin-top:-5px; margin-left:-15px; background:#009900;"  onclick="return confirmAct();" value="添加" class="sub_090" />
                 </form>
                    <div class="box-body">
                        <table class="table table-bordered">
                            <tbody><tr style="background: #E0E0E0;">
                                <th style="width:80px;">序号</th>
                                <th style="width:350px;">权限</th>
                                <th style="width:350px;">权限名称</th>
                                <th style="width:150px;">操作</th>
                            </tr>
                            <?php if(is_array($rule)): $i = 0; $__LIST__ = $rule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rul): $mod = ($i % 2 );++$i;?><tr>
                                <!-- <td>1</td> -->
                                <td><?php echo ($rul['id']); ?></td>
                                <td><?php echo ($rul['name']); ?></td>
                                <td><?php echo ($rul['title']); ?></td>
                           
                                <!-- <td>100</td> -->
                                <td style="text-align:center;">    
                                    <a href="<?php echo U('Quanxian/edit2',array('uid'=>$rul['id']));?>" class="btn btn-default1" onclick="return confirmAct();" style="width:70px;">编辑</a>
                                    
                                    <a href="<?php echo U('Quanxian/del2',array('uid'=>$rul['id']));?>" class="btn btn-default2" onclick="return confirmAct();" style="width:4opx;">删除</a>
