...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
           后台权限管理
            <!-- <a href="<?php echo U('Quanxian/add2');?>" class="btn btn-default pull-right"><font color="black">添加后台权限</font></a> -->
        </h1>
    </section>
    ...
    <script type="text/javascript" language="javascript"> 
        ...
        <div class="row">
            <div class="col-md-12">
             ...
             <select class="xiala"  style="margin-top:10px; margin-left:10px; height:27px;" name="sid"> 
                ...
                <input type="text" name="name" class="text"  placeholder="Admin/Msg/list"/>
                <input type="text" name="title" class="text"  placeholder="权限名称"/>
                <input type="submit" class="btn btn-primary"  style="width:120px;"  onclick="return confirmAct();" value="添加" class="sub_090" style="width:80px;"/>
                 </form>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            <tbody><tr style="background: #fbfbfb;">
                            ...
                            <?php if(is_array($rule)): $i = 0; $__LIST__ = $rule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rul): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td style="text-align:center;">  
                                    <a href="<?php echo U('Quanxian/del2',array('uid'=>$rul['id']));?>" class="btn btn-default" onclick="return confirmAct();" title="编辑">删除</a>
