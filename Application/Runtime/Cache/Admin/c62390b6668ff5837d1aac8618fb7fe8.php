        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('chak1',array('id'=>$leibie['id'],'p'=>$_GET['p']));?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                      ...
                      <div  style="float:left;">
                       ...
                       <div class="form-group" >
                        ...
                        <div class="form-group" style="margin-top:10px;">
                                ...
                                <input class="ip" type="text"  name="" id="inputPhone" placeholder="" maxlength="11" style="width:560px;background:#f9f9f9" readonly="readonly" value="<?php echo date('Y-m-d H:i:s');?>" />

                                <input class="ip" type="hidden"  name="starttime" id="inputPhone" placeholder="" maxlength="11" style="width:558px;background:#f9f9f9" readonly="readonly" value="<?php echo time();?>" />
                              </div>    
