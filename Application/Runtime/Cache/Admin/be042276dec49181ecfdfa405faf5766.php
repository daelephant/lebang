...
<aside class="right-side">
   ...
   <script type="text/javascript" language="javascript"> 
     ...
     function submits()  
     {  
         var submitId=document.getElementById('shuomings').value; 
        submitId =  submitId.replace(/\n|\r\n/g,"<br>");  
        document.getElementById('shuoming').value = submitId;
    }  
</script>
<style>
    select{
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('iosedit',['id'=>$ban['id'],'p'=>$_GET['p']]);?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                        ...
                        <div class="box-body">
                          ...
                          <div class="form-group" style="float:left; ">
                                <label for="inputCover">版本号</label>
                                <input class="ip" type="text"  name="banbenhao" id="inputPhone" placeholder="请输入版本号" maxlength="11" style="width:558px;" value="<?php echo ($ban['banbenhao']); ?>"/>
                            </div>
                            
                            <div class="form-group">
                                <label for="inputSubject"  style="height:140px;line-height:140px; position: relative;top: 1px; ">版本说明</label>
                            <textarea name="" id="shuomings"   cols="XX" rows="XX" style="height:140px;width:558px;position: relative;left:-8px;top: 1px;border:#dddddd solid 1px;resize: none ;color:#666;" ></textarea>
                                <input type="hidden" id="shuoming" name="shuoming">
                            </div>
 <script>
         var reg = new RegExp("<br>","g");
        var str = '<?php echo ($ban['shuoming']); ?>';
        str = str.replace(reg,"\n");
        document.getElementById('shuomings').value = str;
 </script> 
                   
                          <div class="form-group">
                                <label for="inputSubject"  style="height:140px;line-height:140px; position: relative;top: 1px; float: left;">团队成员</label>
                                <div name="" id="" cols="30" rows="10" style="height:140px;width:558px;position: relative;left:-1px;top: 1px;border:#dddddd solid 1px; resize: none ;color:#666; text-align:left;font-size:16px; float: left;" >

                                    &nbsp;产品:<input type="text" value="<?php echo ($ban['cname']); ?>" name="cname" style="border:#ffffff solid 1px; "><br>

                                    &nbsp;设计:<input type="text" value="<?php echo ($ban['sname']); ?>" name="sname" style="border:#ffffff solid 1px; "></br>
                                    &nbsp;研发:<input type="text" value="<?php echo ($ban['yname']); ?>" name="yname" style="border:#ffffff solid 1px; "><br>
                                    &nbsp;后端:<input type="text" value="<?php echo ($ban['hname']); ?>" name='hname' style="border:#ffffff solid 1px; "><br>
                                    &nbsp;测试:<input type="text" value="<?php echo ($ban['shiname']); ?>" name='shiname' style="border:#ffffff solid 1px; "><br>
                         ...
                         <div class="form-group" >
                                <label for="inputCover">文件地址</label>
                               <input class="ip"  type="text"  name="app" id="inputPhone" placeholder="请输入文件地址" maxlength="" style="width:558px;" value="<?php echo ($ban['app']); ?>"/>
                            </div>


                    <div style="clear:both;"></div>
                        <div class="form-group" >
                                <label for="inputCover">上线时间</label>
                                <input class="ip"  type="text" disabled="true" name="shijian" id="inputPhone" placeholder="" maxlength="11" style="width:558px;background:#f9f9f9" value="<?php echo date('Y-m-d',$ban['shijian']);?>"/>
                            </div>
