    ...
    <section class="content-header">
      <h1>
        <div>
            ...
            <font class="font" >服务类别</font>  
            <!-- <p style="width:81px;23px;">待审核用户 </p> -->
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Fuwu/fetchlist2');?>' method="get">
      <input type="text" id="keyword"  class="txt1"  autocomplete="off" name="name" />
      <button type="submit" class="search_btn" value="" >
      <span class="ico" id="scico"><em></em></span></button>
      </form>
</div>
    <div style="float:right;">
            <?php if($_GET['name'] != ''): ?><a href= "javascript:history.back(-1);" class="btn btn-default0 pull-right">返回</a>
            <?php else: ?>
            <a href="<?php echo U('Fuwu/add1');?>" class="btn btn-default0 pull-right">新增类别</a><?php endif; ?>
        </div>
        </div>
       </h1>
    </section>
                    ...
                    <div class="box-body">
                         <table class="table table-bordered" >
                            ...
                            <tr style="background: #fbfbfb;">
                                ...
                                <th>图标</th>
                                <th style="width:120px;">服务项目数量</th>
                                <th style="width:80px;">商户数</th>
                                <th style="width:80px;">预约数</th>
                            ...
                            <?php if(is_array($leibie)): $k = 0; $__LIST__ = $leibie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leibie): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td><?php echo ($leibie['bname']); ?> </td>
                                <td><a href="javascript:void(0)" id="click_pic4" onclick="click_pic(4)">
                            <img id="imghead1" width=64px; height=64px; border=0 src='/photo/leibie/s_<?php echo ((isset($leibie["logo"]) && ($leibie["logo"] !== ""))?($leibie["logo"]):"fuwu.png"); ?>'>
                            </a></td>
                                <td><?php echo ($leibie['xiangmus']); ?></td>
                                <td><?php echo ($shanghu[$k-1]['shanghus']); ?></td>
                                <td><?php echo ($yuyue[$k-1]['yuyues']); ?></td>
                                <td><?php echo date('Y-m-d H:i:s',$leibie['shijian']);?></td>
                                <td><a href="<?php echo U('edit', array('id'=>$leibie['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" title="编辑">查看详情</a></td>
