...
<aside class="right-side">
   ...
   <form id="user_search" action='<?php echo U('Shanghu/fetch2');?>' method="get">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                               ...
                               <th style="width:80px;">序号</th> 
                                ...
                                <th style="width:70px;">完成任务</th>
                                <th style="width:70px;">新鲜事</th>
                                <th style="width:70px;">评论</th>
                                <th style="width:70px;">发任务</th>
 ...
 <td><a href="<?php echo U('Fuwu/xiangmu',array('user_id'=>$user['id'],'p'=>$_GET['p']));?>"><?php echo ($user['fuwus']); ?></a></td>
                                <td><?php echo $order[$user['id']]|0;?></td>
                                <td><?php echo $renwu[$user['id']]|0;?></td>
                                <td><?php echo ($user['xinxianshi']); ?></td>
                                
                                <td><?php echo ($user['pinglunshu']); ?></td>
                                <td><?php echo ($user['renwu']); ?></td>
                               
                                <td></td>
                                <td>
                                   <a href="<?php echo U('rbianji', array('user_id'=>$user['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" style="width:60px;" >详情</a> 
                                   
                                   <a href="<?php echo U('Fuwu/add2', array('user_id'=>$user['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" style="background:#009900; width:60px;" >新增</a>
                                </td>
