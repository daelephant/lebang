...
<aside class="right-side">
   ...
   <form id="user_search" action='<?php echo U('Xinxianshi/fetch1');?>' method="get" onsubmit="checks()">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($xinxianshi)): $k = 0; $__LIST__ = $xinxianshi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xinxianshi): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td><?php echo date('Y-m-d H:i:s',$xinxianshi['shijian']);?></a></td>  
                                <td> 
                                   <?php if($xinxianshi['xianshi']== 1): ?><input type="button" onclick="add(<?php echo ($xinxianshi['id']); ?>)" class="btn btn-default2" style="width:100px;" value="禁用"><?php else: ?> 已禁用<?php endif; ?>
                                </td> 
...
<form action="<?php echo U('bianji',array('p'=>I('get.p')));?>" method="get" onsubmit="return check()">
