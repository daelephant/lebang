...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
           后台分组管理
           <!--  <a href="<?php echo U('Quanxian/add1');?>" class="btn btn-default pull-right"><font color="black">添加后台分组</font></a>
        </h1> -->
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <form action="<?php echo U('Admin/Quanxian/add1');?>" method="post">
                     <label   style="margin-top:10px; margin-left:10px;" for="inputSubject">分类名称&nbsp;:</label>
                                   
                         <input type="text" name="title" id="title" placeholder="" maxlength="20" />
                         <button class="btn btn-primary"  style="width:120px;"  type="submit" name="submit" onclick="return confirmAct();" value="publish">添加</button>
                     </form>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <?php if(is_array($use)): $i = 0; $__LIST__ = $use;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <?php if($user["id"] != 1): ?><a href="<?php echo U('Quanxian/edit1',array('uid'=>$user['id']));?>" class="btn btn-default" title="编辑">编辑</a>
                                    <a href="<?php echo U('Quanxian/del1',array('uid'=>$user['id']));?>" class="btn btn-default" onclick="return confirmAct();" title="编辑">删除</a><?php endif; ?>
