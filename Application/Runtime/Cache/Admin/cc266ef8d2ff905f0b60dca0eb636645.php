...
<aside class="right-side">
    ...
    <section class="content-header">
       ...
       <div style="float:right;">
            ...
            <a href="<?php echo U('Quanxian/add');?>" class="btn btn-default0 pull-right">新增用户</a>
    ...
    input{
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form action="<?php echo U('Admin/Quanxian/add1');?>" method="post">
                     <label for="inputSubject"style="margin-top:10px; margin-left:10px;">分类名称</label>
                                   
                         <input type="text" class="ip" name="title" id="title" placeholder="" maxlength="20" />
                         <button class="btn btn-primary"  style="width:100px; height:40px; background:#009900; margin-top:-5px;"  type="submit" name="submit" onclick="return confirmAct();" value="publish">添加</button>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <?php if(is_array($use)): $i = 0; $__LIST__ = $use;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                <!-- <td>1</td> -->
                                ...
                                <?php if($user["id"] != 1): ?><a href="<?php echo U('Quanxian/edit1',array('uid'=>$user['id']));?>" class="btn btn-default1"style="width:70px;">查看详情</a>
                                    <a href="<?php echo U('Quanxian/del1',array('uid'=>$user['id']));?>" class="btn btn-default2" onclick="return confirmAct();" style="width:40px;">删除</a><?php endif; ?>
