        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('iosadd');?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                        ...
                        <div class="box-body">
                          ...
                          <div class="form-group">
                                ...
                                <div name="demand" id="" cols="30" rows="10" style="height:140px;width:558px;position: relative;left:-1px;top: 1px;border:#dddddd solid 1px; resize: none ;color:#666; text-align:left;font-size:16px; float: left;" >
                                    ...
                                    &nbsp;产品:<input type="text" name="cname" value="" style="border:#ffffff solid 1px; "><br>

                                    &nbsp;设计:<input type="text" name="sname" value="" style="border:#ffffff solid 1px; "></br>
                                    &nbsp;研发:<input type="text" name="yname" value="" style="border:#ffffff solid 1px; "><br>
                                    &nbsp;后端:<input type="text" name="hname" value="" style="border:#ffffff solid 1px; "><br>
                                    &nbsp;测试:<input type="text" name="shiname" value="" style="border:#ffffff solid 1px; "><br>
