   ...
   <!--  <section class="content"> -->
        ...
        <div class="row">
            ...
            <form action='<?php echo U('User/fetch');?>' method="get">
               ...
               <?php
 $starttime = date('Y-m-d',strtotime('-100 days')); $endtime= date('Y-m-d'); ?><table style="margin-left: 10px;" border="0" cellpadding="0" cellspacing="0">
                <tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php if(is_array($user_list)): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td style="width: 249px">
                                    ...
                                    var value = prompt("请输入您的名字", ""); //将输入的内容赋给变量 name ，  
