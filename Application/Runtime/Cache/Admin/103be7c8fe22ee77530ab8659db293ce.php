...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            编辑参数
             <a href="<?php echo U('Master/list');?>" class="btn btn-default pull-right"><font color="black">参数设置</font></a>
        </h1>
    </section>
    ...
    <!-- <section class="content"> -->
     ...
     {  
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                     <form action="<?php echo U('Admin/master/edit',array('id'=>$row['id']));?>" method="post"  onsubmit="return submits();">
                    <select class="xiala" style= "margin-top:10px; margin-left:10px; margin-bottom:10px;" name="sid">
                        <?php if(is_array($cats)): foreach($cats as $key=>$c): if($row['sid'] == $c['id']): ?><option value ="<?php echo ($c['id']); ?>" selected><?php echo (str_repeat("&nbsp",$c['lev'])); echo ($c['mname']); ?></option>
                        <?php else: ?>
                         <option value ="<?php echo ($c['id']); ?>"><?php echo (str_repeat("&nbsp",$c['lev'])); echo ($c['mname']); ?></option><?php endif; endforeach; endif; ?>
                ...
                <input type="text" name="mname" class="text" value="<?php echo ($row['mname']); ?>" placeholder="参数名称"/>
