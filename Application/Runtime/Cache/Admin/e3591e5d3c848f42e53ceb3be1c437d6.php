    ...
    <section class="content-header">
      <h1>
        <div>
            ...
            <font class="font" >商户服务</font>  
            <!-- <p style="width:81px;23px;">待审核用户 </p> -->
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Fuwu/shanghufetch');?>' method="get">
      <input type="text" id="keyword"  class="txt1"  autocomplete="off" placeholder="" name="mingcheng" />
     ...
     <div style="float:right;">
            ...
            <?php else: ?>
            <a href="<?php echo U('Fuwu/add');?>" class="btn btn-default0 pull-right">新增服务</a><?php endif; ?>
        </div>
        </div>
       </h1>
    </section>
                    ...
                    <div class="box-body">
                         <table class="table table-bordered" >
                            ...
                            <tr style="background: #fbfbfb;">
                                ...
                                <th style="80px;">序号</th>
                                <th style="120px;">服务项目名称</th>
                                <th style="100px;">服务类别</th>
                                <th style="200px;">商户名称</th>
                                <th style="100px;">联系人</th>
                                <th style="100px;">手机号码</th>
                                <th style="70px;">价格</th>
                                <th style="70px;">预约数</th>
                                <th style="70px;">评价</th>
                                <th style="110px;">开启时间</th>
                                <th style="width:150px">操作</th> 
                            </tr>
                            <?php if(is_array($leibie)): $k = 0; $__LIST__ = $leibie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leibie): $mod = ($k % 2 );++$k;?><tr>
                                <td><?php echo ($leibie['id']); ?></td>
                                <td><?php echo ($leibie['name']); ?></td>
                                <td><?php echo ($leibie['lname']); ?></td>
                                <td><?php echo ($shanghu[$k-1]['mingcheng']); ?> </td>
                                <td><?php echo ($shanghu[$k-1]['username']); ?></td>
                                <!-- <td><?php echo ($xinxianshi['status']); ?></td> -->
                                <td><?php echo ($shanghu[$k-1]['phone']); ?></td>
                                <td><?php echo ($leibie['jine']); ?></td>
                                <td><?php echo ($yuyue[$k-1]['yuyues']); ?></a></td>         
                                <td></td>         
                                    
                                <td><?php echo date('Y-m-d H:i:s',$leibie['starttime']);?></td>
                                <td>
                                <?php if($leibie['status'] == 0): ?>已禁用
                                <?php else: ?>
                                <a href="<?php echo U('chaksh', array('id'=>$leibie['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" >查看详情</a><?php endif; ?>
                                </td>
