...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">推荐商户</font> 
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="user_search" action='<?php echo U('Shanghu/fetch3');?>' method="get">
...
<td><a href="<?php echo U('Fuwu/xiangmu',array('user_id'=>$user['id'],'p'=>$_GET['p']));?>"><?php echo ($user['fuwus']); ?></a></td>
                                ...
                                <td></td>
                                <td>
                                   <a href="<?php echo U('rtuijian', array('user_id'=>$user['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" title="编辑">查看详情</a> 
                                </td>
