...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            添加后台用户
             <a href="<?php echo U('Quanxian/list');?>" class="btn btn-default pull-right"><font color="black">后台用户</font></a>
        </h1>
        <!-- <ol class="breadcrumb">
                    ...
                    <form action="<?php echo U('Quanxian/add');?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="username" placeholder="" maxlength="20" /><br />
                                </div>
                            <div class="form-group">
                                <label for="inputSubject">密&nbsp;&nbsp;码:</label>
                                <input type="password" name="password" id="password" placeholder="" maxlength="20" /><br />
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer clearfix">
                           <!--  <a href="<?php echo U('edit', ['user_id'=>$user['id']]);?>" class="btn btn-default" title="编辑"><span class="fa fa-edit"></span> 编辑</a> -->
                            <button class="btn btn-primary" type="submit"  style="width:120px;" id="submit"  name="submit" onclick="return confirmAct();" value="publish">添加</button>
