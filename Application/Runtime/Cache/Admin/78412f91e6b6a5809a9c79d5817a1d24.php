...
.radio, .checkbox {
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="div-center">
                    <form action="<?php echo U('Quanxian/add');?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">

                        <div class="box-body">
                          
                            <div class="form-group">
                                <label for="inputSubject">用户名</label>
                                <input type="text" class="ip" style="width:700px;" name="username" id="username" placeholder="请输入用户名" maxlength="" /><br />
                                </div>
                            <div class="form-group">
                                <label for="inputSubject">姓名</label>
                                <input type="text" class="ip" style="width:700px;" name="realname" id="username" placeholder="请输入姓名" maxlength="" /><br />
                                </div>

                            <div class="form-group">
                                <label for="inputSubject">密码</label>
                                <input type="password"style="width:700px;" class="ip" name="password" id="password" placeholder="请输入密码" maxlength="20" /><br />
                            </div>
                         ...
                         <div class="form-group" styel="margin-top:20px;" style="float:left;">
                                ...
                                <div class='ip' style="float:left;width:700px;position:relative;left:-1px;top: 0px;">
                                    &nbsp;<input class="radio" type="radio" name="qiyong" value ="1" checked>启用
                                   &nbsp;<input class="radio" type="radio" name="qiyong" value ="0" >禁用
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class='ip' style="float:left;width:700px;position:relative;left:-1px;top:0px;height:100px;"> 
                                    <?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><td>&nbsp;<input class="radio" type="radio" name="groups" id="inputSubject"  value="<?php echo ($group['id']); ?>|<?php echo ($group['title']); ?>"></td><?php echo ($group['title']); endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
 ...
 <div class="form-group" style="clear:both;" ></div>
                       <div class="form-group" style="float:left;" >
                            ...
                            <button class="btn btn-primary0" type="submit"  style="width:780px;" id="submit"  name="submit" onclick="return confirmAct();" value="publish">添加</button>
