        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="div-center"><!--/*居中*/-->
                  <form action="<?php echo U('Shanghu/rbianji/user_id/'.I('get.user_id'));?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                <div class='left' style='float:left'>
                        ...
                        <div class="box-body">
                             ...
                             <div class="form-group">
                                ...
                                <input class="ip" type="text" name="phone" id="inputPhone" placeholder="请输入手机号码" maxlength="" value="<?php echo ($shanghu['phone']); ?>" readonly ="readonly" style="background:#f9f9f9"/>
                                <datalist id="country">
                                </datalist>
                            </div>
                        ...
                        <div class="form-group" style="margin-top:30px;">
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group" >
                                ...
                                <input class="ip" type="date" name="birthday" id="birthday" placeholder="" maxlength="" style="text-indent:4px;" value="<?php echo date('Y-m-d',$shanghu['birthday']);?>"/>
                            </div>

                            <div class="form-group" >
                                <label for="inputCover">身份证号</label>
                                <input class="ip" type="text" name="idnumber" id="idnumber"  maxlength="" value="<?php echo ($shanghu['idnumber']); ?>"/>
                            </div>
...
<script>
  ...
  // });
                          ...
                          <input type="button" class="btn btn-default1"  onclick="add2(<?php echo I('get.user_id');?>)" value="推荐" style="width:150px;height:40px"></input>
