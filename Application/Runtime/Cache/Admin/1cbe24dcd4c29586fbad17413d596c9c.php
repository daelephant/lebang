...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">ios版</font> 
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Banben/fetch1');?>' method="get">
...
<div class="search" style="float:left;margin-left: 20px;">
         ...
         <div style="float:right;">
            ...
            <?php else: ?>
            <a href="<?php echo U('Banben/iosadd');?>" class="btn btn-default0 pull-right">新增版本</a><?php endif; ?>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                          ...
                          <?php if(is_array($ban)): foreach($ban as $key=>$ban): ?><tr>
                                ...
                                <td  id="newstr" style="vertical-align: super;text-align:left;"><?php echo ($ban['shuoming']); ?></td>
                                ...
                                <td >
                                    <a href="<?php echo U('Banben/iosedit', ['id'=>$ban['id'],'p'=>$_GET['p']]);?>" class="btn btn-default1" title="编辑" style="width:100px;">编辑</a><br>
