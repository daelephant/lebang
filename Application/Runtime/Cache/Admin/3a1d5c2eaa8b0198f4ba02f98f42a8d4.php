        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="div-center">
                    <form action="<?php echo U('Quanxian/edit2',array('uid'=>$rul['id']));?>" method="post" enctype="multipart/form-data">
                     
                        <div class="box-body">
                         

                            <div class="form-group">
                                <label for="inputSubject">权限</label>
                                        <input type="text" class ='ip' name="name" id="username" placeholder="" maxlength="" value="<?php echo ($access['name']); ?>" /><br/>
                                </div>
                        <div class="form-group">
                                <label for="inputSubject">权限名称</label>
                                <input type="text" name="title" class ='ip'  id="username" placeholder="" maxlength="" value="<?php echo ($access['title']); ?>" /><br />
                                </div>
                        ...
                        <div class="box-footer clearfix">
                            ...
                            <button class="btn btn-primary0"  style="width:380px;"  type="submit" name="submit" onclick="return confirmAct();" value="publish">保存</button>
