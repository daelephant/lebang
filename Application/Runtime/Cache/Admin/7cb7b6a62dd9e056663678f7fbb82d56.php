...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            消息列表
            <a href="<?php echo U('Msg/add');?>" class="btn btn-default pull-right"><font color="black">添加消息</font></a>
        </h1>
       <!--  <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box">
                    <!-- <div class="box-header">
                        ...
                        <a href="<?php echo U('Msg/add');?>" class="btn btn-default pull-right">添加消息</a>
                    </div> --><!-- /.box-header -->
                    <div class="box-body">
                        <table style="margin-left: -5px;margin-top: -4px;" class="table table-bordered">
                            ...
                            <tr style="background: #fbfbfb;">
                                ...
                                <th style="text-align:center;  width:15px;">列表</th>
                                <th style=" width:200px; text-align:center;">标题</th>
                                <th style="text-align:center;">简介</th>
                                <th style="text-align:center;">内容</th>
                                
                                <!-- <th>图片</th> -->
                                <th style="width:155px; text-align:center;">发布时间</th>
                                <th style="text-align:center;">操作</th>
                            </tr>
                            
                            <?php if(is_array($msg_list)): $i = 0; $__LIST__ = $msg_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$msg): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($msg['id']); ?></td>
                                <td><?php echo ($msg['title']); ?></td>
                                <td><?php echo ($msg['brief']); ?></td>
                                <td><?php echo ($msg['content']); ?></td>
                                <!-- <td><?php echo ($msg['pic']); ?></td> -->
                                <td><?php echo ($msg['addtime']); ?></td>
                                
                                <!-- <td><?php echo ($msg['caozuo']); ?></td> -->
                                <!-- <td><?php echo ($msg['create_at']); ?></td>
                                <td><?php echo ($msg['category_title']); ?></td> -->
                                <td style="width:75px;">
                                    <a href="<?php echo U('edit', ['msg_id'=>$msg['id']]);?>" class="btn btn-default" title="编辑">编辑</a>
                                    <!-- <a href="<?php echo U('remove', ['msg_id'=>$msg['msg_id']]);?>" class="btn btn-default" title="删除" onclick="return confirm('您确认要删除吗？');"><span class="fa fa-trash-o"></span> 删除</a> -->
                                </td>
