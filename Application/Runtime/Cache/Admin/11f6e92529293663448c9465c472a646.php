        ...
        <div class="row"  style="margin: 0 auto;">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    ...
                    <form action="<?php echo U('Fuwu/add1',array('p'=>I('get.p')));?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
  ...
  <div style='float: left;'>
                            <div class="form-group">
                                ...
                                <select class="ip" name="sid" style="width:200px;">
                                      ...
                                      <?php if(is_array($fuwu_list)): foreach($fuwu_list as $key=>$vo): ?><option name="sid" value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                      </select>
                                <br/>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <input class="ip" type="text" name="name" id="inputidnumber" placeholder="请输入类别名称" value="" maxlength="20"  style="width:200px;"/><br />
                                <br />
                            </div>
                          ...
                          <div style="float:left;margin-left:-95px;margin-top:-9px;">
                            ...
                            <img id="imghead1" width=64px; height=64px; border=0 src='/img/lbt.png'>
                            </a><br>
                            </div>
...
<script type="text/javascript">
      //图片上传预览    IE是用了滤镜。
        function previewImage(file,id)
        {
          ...
          {
              div.innerHTML ='<a href="javascript:void(0)" id="click_pic'+id+'" onclick="click_pic('+id+')"><img id=imghead width="64" height="64"></a>';
...
//                 img.style.marginLeft = rect.left+'px';
          ...
          else //兼容IE
          {
            ...
            div.innerHTML = '<img id=imghead width="64" height="64">';
            var img = document.getElementById('imghead');
