        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('chak',array('id'=>$leibie['id'],'p'=>$_GET['p']));?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                   ...
                   <div class="box-body">
                      <div  style="float:left;">
                          <div  style="float:left;">
                            ...
                            <div class="form-group">
                                ...
                                <select class="ip" name="erjileibie" id="sid" style="position: relative;left: -16px; width:200px;">
                                  ...
                                  <?php else: ?>
                                  <option value="<?php echo ($leibie1['id']); ?>"><?php echo ($leibie1['name']); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                              </div>

                            <div class="form-group" >
                                <label for="inputCover">计价单位</label>
                                <input class="ip" type="text"  name="danwei" id="inputPhone" placeholder="请输入计价单位" maxlength="" style="width:400px;" value="<?php echo ($fuwuxiangmu['danwei']); ?>" />
                              </div>       
                      </div>
                       ...
                       <div class="form-group" >
                                ...
                                <!-- <textarea name="jianjie" id="" cols="30" rows="10" style="height:80px;width:560px;position: relative;left:-8px;top: 1px;border:#dddddd solid 1px;resize: none ;color:#666;" ><?php echo ($fuwuxiangmu['jianjie']); ?></textarea> -->
                                <input type="text" class="ip" name="jianjie" placeholder="请输入项目简介" maxlength="20"  style="width:558px;" value="<?php echo ($fuwuxiangmu['jianjie']); ?>">
                            </div>
                        ...
                        <div class="form-group" style="margin-top:10px;" >
                                ...
                                <input class="ip" type="text"  name="" id="inputPhone" placeholder="" maxlength="11" style="width:560px;background:#f9f9f9" readonly="readonly" value="<?php echo date('Y-m-d H:s:i',$fuwuxiangmu['starttime']);?>" />
                              </div>    
                      ...
                      <button  class="btn btn-primary1" type="submit" id = "submit" name="submit" onclick="return confirmAct(1);" value="publish" style="width:300px; margin-right:30px;">返回待开通状态
                      </button>
                       <button class="btn btn-primary0"  type="submit" id = "submit" name="submit" onclick="return confirmAct(2);" value="publish" style="width:300px;">保存</button>
                        </div>
