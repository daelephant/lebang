    ...
    <section class="content-header">
      <h1>
        <div>
            ...
            <font class="font" >禁用商户服务</font>  
            <!-- <p style="width:81px;23px;">待审核用户 </p> -->
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Fuwu/jinyongfetch');?>' method="get">
      <input type="text" id="keyword"  class="txt1"  autocomplete="off" name="mingcheng" placeholder=""  />
                    ...
                    <div class="box-body">
                         <table class="table table-bordered" >
                            ...
                            <?php if(is_array($leibie)): $k = 0; $__LIST__ = $leibie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leibie): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <!-- <td><?php echo ($leibie['danwei']); ?></td> -->
                                <td style="text-align:left;"><?php echo ($leibie['beizhu']); ?></td>        
                                <td><?php echo date('Y-m-d H:i:s',$leibie['jinyongshijian']);?></td>
                                <td>
                                     <input type="button" onclick='confirmAct(<?php echo ($leibie['id']); ?>,<?php echo I('get.p')|1;?>)' class="btn btn-default2" style="width:100px;background: #009900;" value="启用">
                                </td>
