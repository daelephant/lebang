...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            编辑消息
            <a href="<?php echo U('Msg/list');?>" class="btn btn-default pull-right"><font color="black">消息列表</font></a>
        </h1>
        <!-- <ol class="breadcrumb">
            <li><a href="<?php echo U('Admin/index');?>"><i class="fa fa-dashboard"></i> 管理中心</a></li>
            <li><a href="<?php echo U('list');?>">运营消息管理</a></li>
    ...
    <!-- <section class="content"> -->
     ...
     {  
        ...
        <div class="row">
            <div class="col-md-12">
               <!--  <div class="box"><a href="<?php echo U('edit', ['msg_id'=>$msg['id']]);?>" class="btn btn-default" title="编辑"><span class="fa fa-edit"></span> 编辑</a> -->
                    <form action="<?php echo U('edit', ['msg_id'=>$msg['id']]);?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                        <div class="box-header">
                            <h3 class="box-title"></h3>
                           <!--  <a href="<?php echo U('Msg/list');?>" class="btn btn-default pull-right">列表</a> -->
                        </div><!-- /.box-header -->
                        ...
                        <div style="margin-left:8px;"
                            ...
                            <div class="form-group">
                                <label style="width: 30%;" for="inputSubject">标&nbsp;&nbsp;题：</label>
                                <input style="margin-left: -277px;width: 595px;" type="text" name="title" value = "<?php echo ($msg['title']); ?>">
                            </div>
                             <div class="form-group">
                                <label for="inputCover">消息封面：</label>
                                <img style="" src="/lebang18/photo/msg/m_<?php echo ((isset($msg['pic']) && ($msg['pic'] !== ""))?($msg['pic']):"msg.png"); ?>"/>
                                </br><span style="margin-left: 75px;font-size:15px;color:red">更改封面:</span><input style="margin-left: 137px;margin-top: -21px;" type="file" name="pic" value = "<?php echo ($msg['pic']); ?>" id="inputCover" class="">
                                <input type="hidden" name="pic" value = "<?php echo ($msg['pic']); ?>" id="inputSubject" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">简&nbsp;&nbsp;介：</label>
                                <input style="width: 595px;" type="text" name="brief" value = "<?php echo ($msg['brief']); ?>">
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">内&nbsp;&nbsp;容：</label>
                                
                                <p style="width:600px;margin-left: 75px; margin-top: -18px;"><script id="container" name="content" type="text/plain"><?php echo ($msg['content']); ?></script></p>
                                
 
                        </div>
                         <div class="form-group">
                         <?php
 $starttime = date('Y-m-d',$msg['starttime']); $endtime= date('Y-m-d',$msg['endtime']); ?>
                                <label for="inputSubject">在该时期内显示此条消息：</label>
                                <input id="starttime" placeholder="填一个即可2016-08-28" name="starttime" class="inp_wid3" type="date" value="<?php echo ($starttime); ?>"/></td>~<input id="endtime"name="endtime" placeholder="2016-08-29" class="inp_wid3" type="date" value="<?php echo ($endtime); ?>"/>
                            </div>
                        <!-- /.box-body -->
                        <div class="box-footer clearfix">
                            <button style="margin-left: 180px; width:292px; height:33px;" class="btn btn-primary" type="submit" id = "submit" name="submit"  onclick="return confirmAct();"  value="publish">保存</button>
