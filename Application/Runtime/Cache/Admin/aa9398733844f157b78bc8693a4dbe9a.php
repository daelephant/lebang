        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('Fuwu/add2',array('user_id'=>$user['id'],'p'=>$_GET['p']));?>" method="post" enctype="multipart/form-data" onsubmit="return checks();">  
                   <div class="box-body">
                      <div  style="float:left;">
                          <div  style="float:left;">
...
<link href="/Public/Admin/add/zyzn_2.css" type="text/css" rel="stylesheet">
<script>
  var __LocalDataCities = <?php echo ($xiangmu); ?>;
</script>
<script type="text/javascript" src="/Public/Admin/add/areadata.js"></script>


                                
                                <!-- <input class="ip" type="text" name="name" id="inputPhone" placeholder="请输入项目名称" maxlength="" style="width:400px;" value="" /> -->

                                <input type="text" class="ip" id="danxuan" value="" name="name" data-value="" placeholder="请输入项目名称" style="width:400px;" onclick="appendCity(this,'danxuan')"/>
<!--                                 <select name="name" class="ip" style="width:400px;" id="">
                                    <option value="">请选择项目名称</option>
                                <?php if(is_array($fuwuxiangmu)): foreach($fuwuxiangmu as $key=>$fuwu): ?><option name="name" value=""><?php echo ($fuwu['name']); ?></option><?php endforeach; endif; ?>
                                 <input type="hidden" name="starttime"  value="<?php echo ($fuwu['starttime']); ?>">
                                 <input type="hidden" name="status"  value="<?php echo ($fuwu['status']); ?>">
                                </select> -->

                            </div>

<script>  appendCity($('#danxuan'),'danxuan');</script>  

<script>
    function getAjaxFuwu(id){
      $.ajax({   
          url:"<?php echo U('Fuwu/ajaxfuwu');?>",   
          type:'post',   
          data:'id=' + id, 
            ...
            $('#sid').append("<option value='"+data[i].id+"'>"+data[i].name+"</option>");
                            ...
                            <div class="form-group">
                                ...
                                <select class="ip" name="yijileibie" id="aid" style="width:200px;background:#f9f9f9;" readonly="true"; value="" onchange="getAjax(this.value)">
                                  <option value="" selected><?php echo ($fuwuxiangmu['yijileibie']); ?></option>
                                  <?php if(is_array($leibie)): $i = 0; $__LIST__ = $leibie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leibie): $mod = ($i % 2 );++$i; if($leibie['id'] == $fuwuxiangmu['yijileibie']): ?><option value="<?php echo ($leibie['id']); ?>" name="yijileibie" selected><?php echo ($leibie['name']); ?></option>
                                  <?php else: ?>
                                  <option name="yijileibie" value="<?php echo ($leibie['id']); ?>"><?php echo ($leibie['name']); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                ...
                                <select class="ip" name="erjileibie" id="sid" style="position: relative;left: -16px; width:200px; background:#f9f9f9;" readonly="true"; >
                                  <option value=""selected><?php echo ($fuwuxiangmu['erjileibie']); ?></option>
                            ...
                            <div class="form-group" >
                                ...
                                <input class="ip" type="text"  name="jine" id="jine" placeholder="请输入金额" maxlength="11" style="width:200px;"  />

                                <input class="ip" type="text"  name="danwei" id="inputPhone" placeholder="请输入金额" maxlength="11" style="position: relative;left: -16px; width:200px;background:#f9f9f9;" readonly="true";  />
                          ...
                          <div style="float:left;margin-left:-95px;margin-top:-9px;">
                            ...
                            <input type="hidden" id="tupian0" name="tupian0" >
                          </div>
                       </div>
 <script>
         function checks(){
             ...
             // return false;
                       ...
                       <div class="form-group">
                                ...
                                <textarea name="jianjie" id="jianjie" cols="30" rows="10" style="height:80px;width:558px;position: relative;left:-8px;top: 1px;border:#dddddd solid 1px;resize: none;color:#666;" ><?php echo ($fuwuxiangmu['jianjie']); ?></textarea>
                            </div>
                      ...
                      <div class="form-group"style="margin:0 auto;width:680px;min-height:180px;text-align: center;">
                            ...
                            <input class="tou-input" type="file" name="tupian1" id="inputCover" onchange="previewImage(this,2)" class="input" style="margin:10px 0px 10px 10px;width:180px;" />
                            </div>
                        ...
                        <div id="preview3" style="margin-top:10px; margin-left:10px;">
                            ...
                            <input class="tou-input" type="file" name="tupian2" id="inputCover" onchange="previewImage(this,3)" class="input" style="margin:10px 0px 10px 10px;width:180px;" />
                            </div>
             ...
             <div style="float:left;">
                        <div id="preview4" style="margin-top:10px; ">
                            ...
                            <input class="tou-input" type="file" name="tupian3" id="inputCover" onchange="previewImage(this,4)" class="input" style="margin:10px 0px 10px 10px;width:180px;" />
                            </div>
                ...
                <div class="form-group" style=" float:left;marign-bottom:5px;margin-top:8px;">
                                ...
                                <select class="ip"   name="fuwumoshi" id="fuwumoshi" style="float:left;position:relative;left:-1px;top: 0px;width:560px">
                                   <option >请选择服务模式</option>
                                   <option  name ="fuwumoshi" value="1" id="fuwumoshi" >到家</option>
                                      <option  name="fuwumoshi" value="2" id="fuwumoshi" >到店</option>
                                      <option  name="fuwumoshi" value="3" id="fuwumoshi" >到家及到店</option>
                                </select>       
                         </div>
                        ...
                        <div class="form-group" style='marign-left:px;'>
                                ...
                                <input class="ip" type="text"  name="mingcheng" id="inputPhone" placeholder="" maxlength="11" style="width:561px;background:#f9f9f9;" readonly="true" value="<?php echo ($shanghu['mingcheng']); ?>"  />
                              </div> 
                        ...
                        <div>
                              <div class="form-group" style="float:left; ">
                                ...
                                <input class="ip" type="text"  name="name1" id="inputPhone" placeholder="" maxlength="11" style="width:241px;background:#f9f9f9;" readonly="true" value="<?php echo ($user['name']); ?>"  />
                            </div>

                            <div class="form-group" style="float:left; position: relative;left: -9px;">
                                <label for="inputCover">手机号码</label>
                                  <input class="ip" type="text"  name="phone" id="inputPhone" placeholder="" maxlength="11" style="width:242px;background:#f9f9f9;" readonly="true" value="<?php echo ($user['phone']); ?>" 
                            </div>
                         </div>  

                      <div class="boxclearfix">
                      <input type="hidden" name="shanghuid"  value="<?php echo ($shanghu['id']); ?>">
...
<form action="<?php echo U('jinyong',array('id'=>$leibie['id'],'p'=>$_GET['p']));?>" method="post">
