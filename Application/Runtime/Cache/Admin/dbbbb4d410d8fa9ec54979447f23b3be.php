...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font" >未支付任务</font>  
            <!-- <p style="width:81px;23px;">待审核用户 </p> -->
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="user_search" action='<?php echo U('Order/fetch1');?>' method="get" onsubmit="return check()">
                        ...
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><tr>
                               <td><?php echo ($order['id']); ?></td>
                                ...
                                <td>
                                   <a href="<?php echo U('nopayk', ['order_id'=>$order['id'],'p'=>$_GET['p']]);?>" class="btn btn-default1" title="">查看详情</a> 
                                </td>
