...
<aside class="right-side">
   ...
   <form id="user_search" action='<?php echo U('Xinxianshi/fetch');?>' method="get" onsubmit="return checks()">
                    ...
                    <div class="box-body">
                         <table class="table table-bordered" >
                            ...
                            <tr style="background: #fbfbfb;">
                                ...
                                <th style="width:80px"><a href="<?php echo U('list3');?>">列表</th>
                                <th>新鲜事详情</th>
                                <th style="width:150px">发布人</th>
                                <th style="width:100px">手机号码</th>
                                <th style="width:150px">所在小区</th>
                                <!-- <th>状态</th> -->
                                <th style="width:80px"><a href="<?php echo U('dianzhanlist');?>">点赞</a></th>
                                <!-- <th>状态</th> -->

                                <th style="width:80px"><a href="<?php echo U('pinglunlist');?>">评论</a></th>
                            ...
                            <?php if(is_array($xinxianshi_list)): $i = 0; $__LIST__ = $xinxianshi_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xinxianshi): $mod = ($i % 2 );++$i;?><tr>  
                                ...
                                <td><a href="<?php echo U('pingluncheck', ['xinxianshi_id'=>$xinxianshi['id']]);?>" title="查看评论"><?php echo ($xinxianshi['pinglunshu']); ?></a></td>
                                <td><?php echo date('Y-m-d H:i:s', $xinxianshi['shijian']);?></td>
                               <!--  <td><?php echo ($xinxianshi['xianshi']=='1'?'启用':'禁用'); ?></td> -->
                                ...
                                <td>
                                   <!--  <?php if($xinxianshi['xianshi']== 1): ?><input type="button" onclick="add(<?php echo ($xinxianshi['id']); ?>)" value="禁用"><?php else: ?> 已禁用<?php endif; ?> -->
                                     <a href="<?php echo U('bianji1', array('xinxianshi_id'=>$xinxianshi['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" title="编辑">查看详情</a>
...
<form action="<?php echo U('bianji',array('p'=>$_GET['p']));?>" method="get" onsubmit="return check()">
