        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('Fuwu/add');?>" method="post" enctype="multipart/form-data"  onsubmit="return checks();">
                      ...
                      <div  style="float:left;">
                          <div  style="float:left;">
                            ...
                            <div class="form-group">
                                ...
                                <select class="ip" name="yijileibie" id="" style="width:200px;" onchange="getAjax(this.value)">
                                  <option value="">一级类别</option>

                                  <?php if(is_array($leibie_list)): $i = 0; $__LIST__ = $leibie_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leibie): $mod = ($i % 2 );++$i;?><option value="<?php echo ($leibie['id']); ?>"><?php echo ($leibie['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
         ...
         for(var i=0;i<data.length;i++){
            $('#sid').append("<option value='"+data[i].id+"'>"+data[i].name+"</option>");
                            ...
                            <div class="form-group" >
                                ...
                                <input class="ip" type="text"  name="danwei" id="inputPhone" placeholder="请输入计价单位" maxlength="" style="width:400px;" value="<?php echo ($order['ordernum']); ?>" />
                              </div>       
                      </div>
        ...
        function checks(){
            ...
            return false;
                       ...
                       <div class="form-group">
                                ...
                                <!-- <textarea name="jianjie" id="" cols="30" rows="10" style="height:80px;width:558px;position: relative;left:-8px;top: 1px;border:#dddddd solid 1px;resize: none ;color:#666;" ></textarea> -->
                                <input type="text" class="ip" name="jianjie" placeholder="请输入项目简介" maxlength="20"  style="width:558px;">
                            </div>
                        ...
                        <div class="form-group" style="width:640px">
                             ...
                             <div class="form-group">
                       <button class="btn btn-primary0"  type="submit" id = "submit" name="submit" onclick="return confirmAct();" value="publish" style="width:640px;margin-top:5px;">保存</button>
                        </div>
