...
<aside class="right-side">
   ...
   <form id="user_search" action='<?php echo U('Shanghu/fetch4');?>' method="get">
    <select name="sosuo" class="sosuo" >
      ...
      <span class="ico" id="scico"><em></em></span></button>
        ...
        <div style="float:right;">
            ...
            <?php else: ?>
            <a href="<?php echo U('Fuwu/add');?>" class="btn btn-default0 pull-right">添加商户</a><?php endif; ?>
        </div>
            <!-- <small>待审核用户</small> -->
        </div>
       </h1>
         ...
         <table class="table table-bordered">
                            ...
                            <?php if(is_array($shanghu)): $k = 0; $__LIST__ = $shanghu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($k % 2 );++$k;?><tr> 
                               ...
                               <td><?php if($user['sex'] == '1'): ?>男<?php elseif($user['sex'] == '2'): ?>女<?php endif; ?>
                                ...
                                <td><?php echo ($user['beizhu']); ?></td>
                                <td><?php echo date('Y-m-d H:i:s',$user['jinyongshijian']);?></td>
                                <td> 
                                 <input type="button" class="btn btn-default2" style="background:#009900;width:100px;"  onclick="add2(<?php echo ($user['id']); ?>,<?php echo $_GET['p']|1;?>)" value="启用">
                                 </td>
...
<form action="<?php echo U('shanghu/qiyong',['p'=>$_GET['p']|1]);?>" method="post" id="qiyong">
