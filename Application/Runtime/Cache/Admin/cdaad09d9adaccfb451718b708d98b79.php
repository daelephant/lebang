                    ...
                    <div class="box-body">
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($tixian_list)): $i = 0; $__LIST__ = $tixian_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tixian): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                <?php if($tixian["status"] == 0): ?><input type="button" class="btn btn-default1" style="width:50px;" onclick="add(<?php echo ($tixian['id']); ?>)" value="提现">
                                 <input type="button" class="btn btn-default2" style="width:50px;"  onclick="add2(<?php echo ($tixian['id']); ?>)" value="拒绝">
