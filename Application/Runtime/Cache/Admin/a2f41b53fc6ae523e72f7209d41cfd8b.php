...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">区域管理</font> 
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="user_search" action='<?php echo U('Shequ/fetch3');?>' method="get" onsubmit="return check()">
...
<div class="search" style="float:left;margin-left: 20px;">
        ...
        <div style="float:right;">
            ...
            <?php else: ?>
            <a href="<?php echo U('Shequ/qyadd');?>" class="btn btn-default0 pull-right">新增区域</a><?php endif; ?>
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <?php if(is_array($area)): $i = 0; $__LIST__ = $area;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$areas): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($areas['id']); ?></td>
                                <td>北京</td>
                                <td><?php echo ($areas['bming']); ?></td>
                                <td><?php echo ($areas['mingcheng']); ?></td>
                                <td style="text-align:left;"><?php echo ($areas['shequ_mingcheng']); ?></td>
                                
                                
                                <td>
                                    <a href="<?php echo U('qybianji', ['areas_id'=>$areas['id'],'p'=>$_GET['p']]);?>" class="btn btn-default1" title="编辑">查看详情</a>
