...
<style>
 ...
 $birthday = date('Y-m-d',strtotime('-20 years')); ?>
                                ...
                                <input class="ip" value="<?php echo ($birthday); ?>" type="date" name="birthday" placeholder="实例格式：1999-10-14" id="inputbirthday"style="text-indent:4px;" >
...
<!--                             <div class="form-group">
                                ...
                                <select class="ip" name="shequid">
                                      <?php if(is_array($shequ_list)): foreach($shequ_list as $key=>$vo): ?><option name="shequid" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["mingcheng"]); ?></option><?php endforeach; endif; ?>
                                      </select>
                        ...
                        -->
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="nation ip" value="" placeholder="请选择服务小区" data-value="" id="suozaixiaoqutxt" onclick="appendhyznbar(this,'duoxuan','suozaixiaoqu')" name="shequtxt"/>
                ...
                for (var i = 0;i <= user_data.length - 1; i++) {
                    if(addr.value == user_data[i].phone){
                        ...
                        if(user_data[i].avatar != ''){
                          $('#imghead1').attr('src','/lebang11-29/photo/avatar/'+user_data[i].avatar);
                        }
                        if(user_data[i].idpic != ''){
                          $('#imghead2').attr('src','/lebang11-29/photo/idpic/'+user_data[i].idpic);
                        }
                    }
                }
            }
