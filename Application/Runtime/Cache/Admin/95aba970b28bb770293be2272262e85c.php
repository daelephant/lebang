...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">H5版</font> 
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Banben/fetch2');?>' method="get">
  ...
  table tbody tr th{
    ...
    table td{
         ...
         <div style="float:right;">
            ...
            <?php else: ?>
            <a href="<?php echo U('Banben/hadd');?>" class="btn btn-default0 pull-right">新增版本</a><?php endif; ?>
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="table table-bordered">
                          ...
                          <?php if(is_array($ban)): foreach($ban as $k=>$ban): ?><tr>
                                ...
                                <td >
                                    <a href="<?php echo U('Banben/hedit', ['id'=>$ban['id'],'p'=>$_GET['p']]);?>" class="btn btn-default1" title="编辑" style="width:100px;">编辑</a><br>
                          
                                    <a href="<?php echo ($ban['app']); ?>" class="btn btn-default1" style="width:100px; margin-top:10px;">查看</a>
