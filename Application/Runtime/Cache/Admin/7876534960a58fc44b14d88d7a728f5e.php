...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            查询结果
             <a href="<?php echo U('Xinxianshi/list6');?>" class="btn btn-default pull-right"><font color="black">所有评论</font></a>
        </h1>
        <ol class="breadcrumb">
             <!-- <form action='<?php echo U('Xinxianshi/fetch');?>' method="get">
                <tr>
                <td style='margin-bottom: 20px'>发帖人：<input id="name" name="name" class="inp_wid3" type="text" value="<?php echo ($_GET['name']); ?>"/></td>
                <td>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <table style="margin-left: -5px;margin-top: -25px;" class="table table-bordered">
                            ...
                            <?php if(is_array($xinxianshi_list)): $i = 0; $__LIST__ = $xinxianshi_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xinxianshi): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($xinxianshi['mingcheng']); ?></td>
                                ...
                                <td >
                                    ...
                                    <input type="button" onclick="add(<?php echo ($xinxianshi['id']); ?>)" value="禁用">
                  ...
                  <!--分页的位置-->
                    <?php echo ($page_html); ?>
       <span  style="margin-right: 550px;float: right;">
            <a href="<?php echo U('Xinxianshi/list6');?>" class="btn btn-primary">返&nbsp;回</a>
       </span>
            </div>
        </div>
