    ...
    <section class="content-header">
       <h1>
        <div>
            ...
            <font class="font" >屏蔽新鲜事</font>  
            <!-- <p style="width:81px;23px;">待审核用户 </p> -->
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="user_search" action='<?php echo U('Xinxianshi/fetch3');?>' method="get">
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($xinxianshi_list)): $k = 0; $__LIST__ = $xinxianshi_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xinxianshi): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td><?php echo ($xinxianshi['pinglunshu']); ?></a></td>
                                <td style="text-align:left;"><?php echo ($xinxianshi['beizhu']); ?></td>
                                <td> 
                                 <a href="<?php echo U('pingbik', array('xinxianshi_id'=>$xinxianshi['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" title="编辑">查看详情</a>
                                </td> 
