...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            新鲜事编辑
            <a href="<?php echo U('Xinxianshi/list');?>" class="btn btn-default pull-right"><font color="black">所有新鲜事</font></a>
        </h1>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form action="<?php echo U('Xinxianshi/bianji1');?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?=$xinxianshi['id']?>">
                        <div class="box-header">
                            <h3 class="box-title"></h3>
                            <!-- <a href="<?php echo U('list');?>" class="btn btn-default pull-right">新鲜事列表</a> -->
                        </div><!-- /.box-header -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <sapn><?php echo ($xinxianshi['name']); ?></span>
                                <!-- <input value="<?php echo ($xinxianshi['name']); ?>"  type="text" name="name" id="inputPhone" maxlength="11" /><br /> -->
                            ...
                            <div class="form-group">
                                <label for="inputbirthday">所在社区:</label>
                                 <td><?php if(empty($xinxianshi['mingcheng'])): ?>体验小区<?php else: ?>  
                                <?php echo ($xinxianshi['mingcheng']); endif; ?></td>
                                <!-- <input value="<?php echo ($xinxianshi['mingcheng']); ?>"  type="text" name="mingcheng"id="inputbirthday" > -->
                            </div>
                          ...
                          <!--   <tr><TD align="right" width=120 height=60></TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<TD align="right" width=120 height=80></TD></tr>  -->
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?php echo ($xinxianshi['neirong']); ?>"  type="hidden" name="neirong" id="inputidnumber" placeholder="max<20位" maxlength="20" /><textarea value="<?php echo ($xinxianshi['neirong']); ?>" name="neirong" style=" height:100%;" 

                                ><?php echo ($xinxianshi['neirong']); ?></textarea>&nbsp;&nbsp;&nbsp;
                                
                               <!--  <label for="inputSubject">审核备注</label>
                                <input value="<?php echo ($xinxianshi['beizhu']); ?>"  type="hidden" name="beizhu" id="inputidnumber" placeholder="max<20位" maxlength="20" /><textarea value="<?php echo ($xinxianshi['beizhu']); ?>" name="beizhu" style=" height:100%;" 

                                ><?php echo ($xinxianshi['beizhu']); ?></textarea> --><br />
                       ...
                       <!-- /.box-body -->
                      <div class="form-group">
                                <label for="inputbirthday">置顶选择:</label>
                                 <td><select   name="top" style="height:26px; width:151px;">
                                      <option  name ="top" value="0" <?php if($xinxianshi["top"] == 0): ?>selected<?php endif; ?> >不置顶</option>
                                      <option  name="top" value="1" <?php if($xinxianshi["top"] == 1): ?>selected<?php endif; ?> >小区置顶</option>
                                      <option  name="top" value="2" <?php if($xinxianshi["top"] == 2): ?>selected<?php endif; ?> >区域置顶</option>
                                      <option  name="top" value="3" <?php if($xinxianshi["top"] == 3): ?>selected<?php endif; ?> >城市置顶</option>
                                      <option  name="top" value="4" <?php if($xinxianshi["top"] == 4): ?>selected<?php endif; ?> >全国置顶</option>
                                </select></td>
                            </div>
                        <div class="box-footer clearfix">
                           <!--  <a href="<?php echo U('edit', ['xinxianshi_id'=>$xinxianshi['id']]);?>" class="btn btn-default" title="编辑"><span class="fa fa-edit"></span> 编辑</a> -->
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <?php if(empty($xinxianshi['zhaopian0'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian0']) && ($xinxianshi['zhaopian0'] !== ""))?($xinxianshi['zhaopian0']):"xinxianshi.png"); ?>"/><?php endif; ?>
                                </td>
                                <td>
                                  <?php if(empty($xinxianshi['zhaopian1'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian1']) && ($xinxianshi['zhaopian1'] !== ""))?($xinxianshi['zhaopian1']):"xinxianshi.png"); ?>"/><?php endif; ?>
                                </td>
                                <td>
                                  <?php if(empty($xinxianshi['zhaopian2'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian2']) && ($xinxianshi['zhaopian2'] !== ""))?($xinxianshi['zhaopian2']):"xinxianshi.png"); ?>"/><?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                   <?php if(empty($xinxianshi['zhaopian3'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian3']) && ($xinxianshi['zhaopian3'] !== ""))?($xinxianshi['zhaopian3']):"xinxianshi.png"); ?>"/><?php endif; ?>
                                </td>
                                <td>
                                   <?php if(empty($xinxianshi['zhaopian4'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian4']) && ($xinxianshi['zhaopian4'] !== ""))?($xinxianshi['zhaopian4']):"xinxianshi.png"); ?>"/><?php endif; ?>
                                </td>
                                <td>
                                  <?php if(empty($xinxianshi['zhaopian5'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian5']) && ($xinxianshi['zhaopian5'] !== ""))?($xinxianshi['zhaopian5']):"xinxianshi.png"); ?>"/><?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                   <?php if(empty($xinxianshi['zhaopian6'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian6']) && ($xinxianshi['zhaopian6'] !== ""))?($xinxianshi['zhaopian6']):"xinxianshi.png"); ?>"/><?php endif; ?>
                                </td>
                                <td>

                                  <?php if(empty($xinxianshi['zhaopian7'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian7']) && ($xinxianshi['zhaopian7'] !== ""))?($xinxianshi['zhaopian7']):"xinxianshi.png"); ?>"/><?php endif; ?>
                                </td>
                                <td>
                                    <?php if(empty($xinxianshi['zhaopian8'])): else: ?>  
                                    <img style="margin-left: 5px;width: 200px;height: 200px;" src="/lebang18/photo/xinxianshi/s_<?php echo ((isset($xinxianshi['zhaopian8']) && ($xinxianshi['zhaopian8'] !== ""))?($xinxianshi['zhaopian8']):"xinxianshi.png"); ?>"/><?php endif; ?>         
                                </td>
                            </tr>
                        </table>
                        </div>
