...
<aside class="right-side">
    ...
    <section class="content-header">
         <h1>
            <font class="font">雷锋用户详情</font>
            <a href="javascript:history.back(-1);" class="btn btn-default0 pull-right" style="position:relative;bottom:8px;" >返回雷锋用户</a>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                   <form action="<?php echo U('User/cklf',array('p'=>I('get.p')));?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                        <input type="hidden" name="id" id="inputname" maxlength="20" value="<?php echo ($user['id']); ?>" />
                        <div class="box-body">
                        
                            <div class="form-group">
                                <label for="inputCover">手机号</label>
                                <input  class="ip" type="text" name="phone" id="inputPhone" value="<?php echo ($user['phone']); ?>" maxlength="11" disabled="true" style="background:#f9f9f9"/><br />
                            ...
                            <div class="form-group">
                                ...
                                <input class="ip" type="text" name="nickname" id="inputname" value="<?php echo ($user['nickname']); ?>" maxlength="20" /><br />
                                </div>
                            <!-- <div class="form-group">
...
<script>
  ...
  svae_znitem();
                            ...
                            <div class="form-group" style="margin-top:26px;">
                                ...
                                <input  class="ip"type="text" name="name" id="inputname" maxlength="20" value="<?php echo ($user['name']); ?>" disabled="true" style="background:#f9f9f9" /><br />
                            </div>
                             <div class="form-group">
                                <label for="inputSubject">性别</label>
                                <select  class="ip"  name="sex" disabled="true" style="background:#f9f9f9">
                            ...
                            <div class="form-group">
                                <label for="inputSubject">生日</label>
                                 <?php
 $birthday = date('Y-m-d',$user['birthday']); ?>       
                                <input class="ip" type="date" name="birthday"   value="<?php echo ($birthday); ?>" id="inputbirthday" style="text-indent:4px;background:#f9f9f9"  disabled="true" >
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">身份证号</label>
                                <input class="ip" type="text" name="idnumber" id="inputidnumber"  value="<?php echo ($user['idnumber']); ?>" readonly="true" maxlength="20"  disabled="true" style="background:#f9f9f9"/><br />
                            </div>
                           
                            
                           <div class="form-group">
                                <label for="inputSubject">注册时间</label>
                                <input class="ip" type="text" name="idnumber" id="inputidnumber" value="<?php echo date('Y-m-d H:i:s',$user['regtime']);?>" maxlength="20"  disabled="true" style="background:#f9f9f9" /><br />
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">认证时间</label>
                           <input class="ip" type="text" name="idnumber" id="inputidnumber" value="<?php echo date('Y-m-d H:i:s',$user['renzhengtime']);?>" maxlength="20" disabled="true" style="background:#f9f9f9" /><br />
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">最后登录</label>
                          <input class="ip" type="text" name="idnumber" id="inputidnumber" value="<?php echo date('Y-m-d H:i:s',$user['logintimes']);?>" maxlength="20" readonly="true" style="background:#f9f9f9"/><br />
                            </div>
...
<!-- 调用的js--> 
 <script type="text/javascript" src="/Public/Admin/js/tinybox.js"></script>
    ...
    <div class='right' style="width:250px;float:left">
    <div id="content"> 

            <div id="preview1" style="margin-left:10px; ">
                <a href="javascript:void(0)" id="click_pic1" onclick="click_pic(1)">
                <img id="imghead" width=140px; height=140px; border=0 src="/photo/avatar/b_<?php echo ((isset($user['avatar']) && ($user['avatar'] !== ""))?($user['avatar']):"avatar.png"); ?>">
                </a>
            </div><br><br><br><br><br>

            <div id="preview2" style="margin-left:10px; margin-top:-5px;">
                <a href="javascript:void(0)" id="click_pic2" onclick="click_pic(2)">
                <img id="imghead" width=140px; height=140px; border=0 src="/photo/idpic/<?php echo ((isset($user['idpic']) && ($user['idpic'] !== ""))?($user['idpic']):"idpic.png"); ?>">
                </a>
            </div><br><br>
        </div>
     </div>
...
.tcdiv{ display:none;  position:fixed;  top:200px; right:350px; margin:auto; text-align:left;   width: 100%; max-width:400px;  height: 250px;  background-color:#F8F8F8;  z-index:6; padding:10px; border-radius:5px;}
