...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <!-- <ol class="breadcrumb">
            ...
            <li><a href="<?php echo U('list');?>">提现管理</a></li>
            <li class="active">提现交易</li>
        </ol> -->
    </section>
<!-- //s -->
                                    <script type="text/javascript">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                       ...
                       <!--  <a href="<?php echo U('User/add');?>" class="btn btn-default pull-right">添加提现</a> -->
                    </div><!-- /.box-header -->
                    <!--  -->
    <!-- <form action='<?php echo U('User/fetch');?>' method="get">
        
                <td style="text-align:right">姓名：<input id="name" name="name" class="inp_wid3" type="text" value="<?php echo ($_GET['name']); ?>"/></td>
                ...
                <td style="text-align:right">查询日期：<input id="starttime" placeholder="填一个即可2016-08-28" name="starttime" class="inp_wid3" type="text" value="<?php echo ($_GET['starttime']); ?>"/></td>~<input id="endtime"name="endtime" placeholder="2016-08-29" class="inp_wid3" type="text" value="<?php echo ($_GET['endtime']); ?>"/></td>
                    ...
                    <div class="box-body">
                        <table style="margin-left: -5px;margin-top: -25px;" class="table table-bordered">
                            ...
                            <tr style="background: #fbfbfb;">
                                ...
                                <th style="width:155px; text-align:center;">提现时间</th>
                               <!--  <th>最后登录</th> -->
                                <th style=" text-align:center;">金额</th>
                                <th style="width:83px; text-align:center;">状态</th>
                            ...
                            <?php if(is_array($tixian_list)): $i = 0; $__LIST__ = $tixian_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tixian): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($tixian['id']); ?></td>
                                <td><?php echo ($tixian['name']); ?></td>
                                <td><?php echo ($tixian['phone']); ?></td>
                                <td><?php echo ($tixian['idnumber']); ?></td>
                                <td><?php echo ($tixian['bank']); ?></td>
                                <td><?php echo ($tixian['banknum']); ?></td>
                                <td><?php echo ($tixian['addtime']); ?></td>
                                <td><?php echo ($tixian['moeny']); ?></td>
                                <td>
                                <?php if($tixian["status"] == 0): ?><font size="3" color="brown">待审核</font>
                                   <?php elseif($tixian["status"] == 1): ?><font size="3" color="green">提现成功</font>
                                   <?php elseif($tixian["status"] == 2): ?><font size="3" color="red">提先失败</font><?php endif; ?>
                                </td>
                                <td><?php echo ($tixian['beizhu']); ?></td>
                                <td>
                                <?php if($tixian["status"] == 0): ?><input type="button" _type="1" onclick="add(<?php echo ($tixian['id']); ?>)" value="提现">
                                 <input type="button" _type="0" onclick="add2(<?php echo ($tixian['id']); ?>)" value="拒绝">
                                 
                                 <?php elseif($tixian["status"] == 2): ?>
                                 <input type="button" _type="1" onclick="add(<?php echo ($tixian['id']); ?>)" value="提现">
                                 <?php elseif($tixian["status"] == 1): ?>OK
