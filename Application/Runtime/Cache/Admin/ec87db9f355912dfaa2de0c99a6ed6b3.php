                        ...
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($tixian_list)): $i = 0; $__LIST__ = $tixian_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tixian): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <?php if($tixian["status"] == 0): ?><font size="3" color="brown">待审核</font>
                                   ...
                                   <?php elseif($tixian["status"] == 2): ?><font size="3" color="red">提现失败</font><?php endif; ?>
                                </td>
                                <td style="text-align:left;"><?php echo ($tixian['beizhu']); ?></td>
                                <td>
                                <?php if($tixian["status"] == 0): ?><input type="button" _type="1" class="btn btn-default1" onclick="add(<?php echo ($tixian['id']); ?>)" value="提现">
                                 <input type="button" _type="0" class="btn btn-default2" onclick="add2(<?php echo ($tixian['id']); ?>)" value="拒绝">
                                 
                                 <?php elseif($tixian["status"] == 2): ?>
                                 <input type="button" _type="1" class="btn btn-default1" style="width:80px;"  onclick="add(<?php echo ($tixian['id']); ?>)" value="提现">
...
<form action="<?php echo U('bianji');?>" method="get">
    ...
    <textarea id="beizhu" class="textarea"  name="beizhu" placeholder="请输入理由......"cols="30" rows="10"></textarea>
    ...
    <input type='button' class="btn btn-default0" style="background:#FFFFFF;border-color: #fbfbfb;color:black;" onclick="removeElement()" value='返回'>
      ...
      &nbsp;&nbsp;
       ...
       <input type="submit" class="btn btn-default0" style="background:#FF6600;"; value="确定">
    </div>
 </form>
