...
<aside class="right-side">
   ...
   <form id="user_search" action='<?php echo U('Xinxianshi/fetch2');?>' method="get">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($xinxianshi_list)): $i = 0; $__LIST__ = $xinxianshi_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xinxianshi): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($xinxianshi['pinglunshu']); ?></td>
                                <!-- <td><?php echo ($xinxianshi['status']); ?></td> -->
                                <td>
                                <?php if($xinxianshi['zhiding'] == 1): ?>小区置顶
                                <?php elseif($xinxianshi['zhiding'] == 2): ?>区域置顶
                                <?php elseif($xinxianshi['zhiding'] == 3): ?>城市置顶
                                <?php elseif($xinxianshi['zhiding'] == 4): ?>全局置顶<?php endif; ?>
                                </td>
                                <td><?php echo date('Y-m-d H:i:s',$xinxianshi['endtime']);?></td>
                               <td><a href="<?php echo U('zhidingk', array('xinxianshi_id'=>$xinxianshi['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" title="编辑">查看详情</a></td>
