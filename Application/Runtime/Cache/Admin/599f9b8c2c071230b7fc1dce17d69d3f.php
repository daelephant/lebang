...
<aside class="right-side">
   ...
   <form id="user_search" action='<?php echo U('Order/fetch');?>' method="get" onsubmit="return check()">
    <select name="sosuo" id="sosuo" class="sosuo">
                                          <option  name="sosuo" value="1">&nbsp;手机号</option>
                                          <option  name="sosuo" value="2">&nbsp;交易编号</option>
                        ...
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><tr>
                               <td><?php echo ($order['id']); ?></td>
                                ...
                                <td>
                                   <a href="<?php echo U('edit', ['order_id'=>$order['id'],'p'=>$_GET['p']]);?>" class="btn btn-default1" title="编辑">查看详情</a> 
                                </td>
