...
$(function(){
    $('#button').click(function(){
        ...
        var $type=$('#type').val();
        var $mess=$('#mess');
        $.getJSON('/lebang11-29/Application/Runtime/Cache',{type:$type},function(json){
            if(json.status==1){
...
<!-- //一键清除所有 -->
<!-- <form action="<?php echo U('Admin/allrun');?>" method="get">
                      <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
                       <tr> -->
     ...
     <!-- <a href="<?php echo U('Admin/clearRuntime');?>"><i class="fa fa-dashboard"></i> 删除缓存</a> -->
    <!-- Main content -->
    <!-- <section class="content"> -->
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr style="background: #fbfbfb;">
                                ...
                                <th style="text-align:center;">数目统计</th>
                                <!-- <th>排序</th> -->
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a href="<?php echo U('User/list1');?>" class="btn btn-default" title="编辑"><!-- <span class="fa fa-edit"></span>  -->查看</a>
                            ...
                            <tr>
                                ...
                                <!-- <td>100</td> -->
                                <td style="text-align:center;">
                                    <a href="<?php echo U('User/list3');?>" class="btn btn-default" title="编辑">查看</a>
                                    <!-- <a href="#" class="btn btn-default" title="删除" onclick="return confirm('是否删除？');"><span class="fa fa-trash-o"></span> 删除</a> -->
                                </td>
                            </tr>
                            <tr>
                              <!--   <td>3</td> -->
                                <td>待审核用户</td>
                                <td><?php echo ($list4); ?></td>
                                <!-- <td>100</td> -->
                                <td style="text-align:center;">
                                    <a href="<?php echo U('User/list2');?>" class="btn btn-default" title="编辑">查看</a>
                                    <!-- <a href="#" class="btn btn-default" title="删除" onclick="return confirm('是否删除？');"><span class="fa fa-trash-o"></span> 删除</a> -->
                                </td>
                            </tr>
                           <tr>
                                <!-- <td>4</td> -->
                                <td>订单</td>
                                <td><?php echo ($list5); ?></td>
                                <!-- <td>100</td> -->
                                <td style="text-align:center;">
                                    <a href="<?php echo U('Order/list');?>" class="btn btn-default" title="编辑">查看</a>
                                    <!-- <a href="#" class="btn btn-default" title="删除" onclick="return confirm('是否删除？');"><span class="fa fa-trash-o"></span> 删除</a> -->
                                </td>
                            </tr>
