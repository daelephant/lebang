...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">待开通小区</font> 
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="user_search" action='<?php echo U('shequ/fetch2');?>' method="get" onsubmit="return check()">
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="table table-bordered">
                            <tbody>
                            <tr>
                                <th style="width:80px;">序号</a></th> 
                                <th style="width:100px;">小区名称</th>
                                <th style="width:80px;">住户</th>
                            ...
                            <?php if(is_array($shequ_list)): foreach($shequ_list as $key=>$shequ): ?><tr>
                                ...
                                <td style="text-align:left;"><?php echo ($shequ['weizhi']); ?></td>
                                
                                <td >
                                    <a href="<?php echo U('Shequ/list', ['shequ_id'=>$shequ['id'],'s'=>'starting','p'=>$_GET['p']]);?>" class="btn btn-default1" title="编辑">查看详情</a>
