        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="div-center">
                    <form action="<?php echo U('Quanxian/edit',array('uid'=>$msg['id']));?>" method="post" enctype="multipart/form-data">
                        <div class="box-body">

                            <div class="form-group">
                                <label for="inputCover">用户名</label>
                                    <input class="ip" type="text" style="width:700px;" name="username" id="inputPhone" placeholder=""  value="<?php echo ($msg['username']); ?>" />
                                </div>

                        <div class="form-group">
                                <label for="inputCover">姓名</label>
                                <input type="text" class="ip" style="width:700px;" name="realname" id="username" placeholder="" maxlength="" value="<?php echo ($msg['realname']); ?>" /><br />
                                </div>

                        <div class="form-group">
                                <label for="inputCover">密码</label>
                                <input type="password" class="ip"style="width:700px;"name="password" id="password" placeholder="密码为空不修改" maxlength="20" /><br />
                            </div>
                        
                       <div class="form-group" styel="margin-top:20px;" style="float:left;">
                                <label for="inputSubject" style="float:left;">启用</label> 
                            
                                <div class='ip' style="float:left;width:700px;position:relative;left:-1px;top: 0px;">
                                    &nbsp;<input class="radio" type="radio" name="qiyong" value ="1" <?php if($msg['qiyong'] == 1): ?>checked<?php endif; ?>>启用
                                    &nbsp;<input class="radio" type="radio" name="qiyong" value ="0" <?php if($msg['qiyong'] == 0): ?>checked<?php endif; ?>>禁用
                                </div>
                        ...
                        <div class="form-group">
                                <label for="inputSubject" style="float:left;line-height:100px;  height:100px;">分组</label> 
                                <div class='ip' style="float:left;width:700px;position:relative;left:-1px;top:0px;height:100px;"> 
                                    <?php if(is_array($mgr)): $i = 0; $__LIST__ = $mgr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i; if($mcc["group_id"] == $group["id"]): ?><td>&nbsp;<input class="radio" type="radio" name="groups" id="inputSubject"  value="<?php echo ($group['id']); ?>|<?php echo ($group['title']); ?>" checked=""></td><?php echo ($group['title']); ?>
                                    <?php else: ?>
                                    <td>&nbsp;<input class="radio" type="radio" name="groups" id="inputSubject"  value="<?php echo ($group['id']); ?>|<?php echo ($group['title']); ?>"></td><?php echo ($group['title']); endif; endforeach; endif; else: echo "" ;endif; ?>
                                 </div>   
                            </div>
                        ...
                        <div class="boxclearfix" >
                            ...
                            <button class="btn btn-primary0"  type="submit" style="width:780px;" name="submit" onclick="return confirmAct();" value="publish">保存</button>
