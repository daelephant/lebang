...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            编辑后台用户
             <a href="<?php echo U('Quanxian/list');?>" class="btn btn-default pull-right"><font color="black">后台管理</font></a>
        </h1>
        <!-- <ol class="breadcrumb">
                    ...
                    <form action="<?php echo U('Quanxian/edit',array('uid'=>$msg['id']));?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <?php echo ($msg['username']); ?><br />
                                </div>
                            <div class="form-group">
                                <label for="inputSubject">密&nbsp;&nbsp;码:</label>
                                <input type="password" name="password" id="password" placeholder="密码为空不修改" maxlength="20" /><br />
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">分&nbsp;&nbsp;组:</label> 
                                <tr >
                                    <?php if(is_array($mgr)): $i = 0; $__LIST__ = $mgr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i; if($mcc["group_id"] == $group["id"]): ?><td>&nbsp;&nbsp;<input type="radio" name="groups" id="inputSubject"  value="<?php echo ($group['id']); ?>|<?php echo ($group['title']); ?>" checked=""></td><?php echo ($group['title']); ?>
                                    <?php else: ?>
                                    <td>&nbsp;&nbsp;<input type="radio" name="groups" id="inputSubject"  value="<?php echo ($group['id']); ?>|<?php echo ($group['title']); ?>"></td><?php echo ($group['title']); endif; endforeach; endif; else: echo "" ;endif; ?>
                                </tr>
                        ...
                        <div class="box-footer clearfix">
                           <!--  <a href="<?php echo U('edit', ['user_id'=>$user['id']]);?>" class="btn btn-default" title="编辑"><span class="fa fa-edit"></span> 编辑</a> -->
                            <button class="btn btn-primary"  style="width:120px;"  type="submit" name="submit" onclick="return confirmAct();" value="publish">保存</button>
