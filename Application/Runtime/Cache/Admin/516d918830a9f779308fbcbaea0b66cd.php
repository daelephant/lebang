        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('zhidingk',['xinxianshi_id'=>$xinxianshi['id'],'p'=>$_GET['p']]);?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                        ...
                        <div class="box-body">
                          <div>
                              <div class="form-group" style="float:left; ">
                                ...
                                <input class="ip" type="text" readonly="readonly" name="nickname" id="inputPhone" placeholder="" maxlength="11" style="width:240px;background:#f9f9f9;" value="<?php echo ($xinxianshi['name']); ?>"value="<?php echo ($xinxianshi['nickname']); ?>" />
                            </div>
              ...
              TINY.box.show(click_pic,0,0,0,1);
                          ...
                          <div>
                            ...
                            <div class="form-group" style="float:left; position: relative;left: -9px;">
                                ...
                                <input class="ip" type="text" disabled="disabled" name="shijian" id="inputPhone" placeholder="" maxlength="" style=" width:240px;background:#f9f9f9;"value="<?php echo date('Y-m-d H:i:s', $xinxianshi['shijian']);?>" />
                            </div>
                         </div>

                         <div>
                              <div class="form-group" style="float:left; ">
                                <label for="inputCover">置顶类型</label>

                                <input class="ip" type="text" readonly="readonly" name="" id="inputPhone" placeholder="" maxlength="11" style="width:240px;background:#f9f9f9;"  
                            <?php if($xinxianshi['zhiding'] == 1): ?>value="小区置顶"/>
                                <?php elseif($xinxianshi['zhiding'] == 2): ?>
                                    value="区域置顶"/>
                                    <?php elseif($xinxianshi['zhiding'] == 3): ?>
                                        value="城市置顶"/>
                                            <?php elseif($xinxianshi['zhiding'] == 4): ?>
                                                value="全局置顶"/><?php endif; ?>
                                                      
                            </div>

                            <div class="form-group" style="float:left; position: relative;left: -9px;">
                                <label for="inputCover">置顶时间</label>
                                  <input class="ip" type="text" disabled="disabled" name="endtime" id="inputPhone" placeholder="" maxlength="11" style="width:240px;background:#f9f9f9;" value="<?php echo date('Y-m-d H:i:s',$xinxianshi['starttime']);?>">
                            </div>
                         </div>
                        ...
                        <div class="boxclearfix">
                            ...
                            <button class="btn btn-primary0"  type="button" onclick="add();" style="width:305px; background:#ff6600;;border:#ff6600;">取消置顶</button>
                           ...
                           <!--  <button class="btn btn-primary0"  type="button" id = "submit" name="submit" onclick="zhiding();" value="publish" style="width:150px; background:#0099ff;;border:#0099ff;margin-left:10px;">置顶</button> -->
                            ...
                            <button class="btn btn-primary0"  type="submit" id = "submit" name="submit" onclick="return confirmAct();" value="publish" style="width:305px;margin-left:20px; ">保存</button>
...
.int{
 ...
 #we{
    ...
    #beizhu{
        resize:block; width:400px; height:200px; border-radius:3px; line-height:200px;padding-left:130px;  
    }
  /*  select{
...
<form action="<?php echo U('zhidingk',['xinxianshi_id'=>$xinxianshi['id'],'p'=>$_GET['p']]);?>)}" method="post">
    <input type="hidden" name="xinxianshi_id"  value="<?php echo ($xinxianshi['id']); ?>"> 
    <input type="hidden" name='zhiding' value="0" id="xid" >
    <div  id="beizhu"><font style="font-size:20px; font-family:MicrosoftYaHei;">取消新鲜事置顶?</font></div>
  
     <div id="we">
    <input type='button' class="btn btn-default0" style="background:#FFFFFF;border-color: #fbfbfb;color:black;margin-left:10px;" onclick="removeElement1()" value='返回'>&nbsp;&nbsp;&nbsp;&nbsp;
        
       <input type="submit" class="btn btn-default0"  style="background:#FF6600;"; value="确定取消置顶">
    </div>
