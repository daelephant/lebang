...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
           后台用户
            <a href="<?php echo U('Quanxian/add');?>" class="btn btn-default pull-right"><font color="black">添加后台用户</font></a>
        </h1>
    </section>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <!-- <td>100</td> -->
                                <td>
                                    <a href="<?php echo U('Quanxian/edit',array('uid'=>$user['id']));?>" class="btn btn-default" title="编辑">编辑</a>
                                    <?php if($user["id"] != 1): ?><a href="<?php echo U('Quanxian/del',array('uid'=>$user['id']));?>" class="btn btn-default" onclick="return confirmAct();"  title="编辑">删除</a><?php endif; ?>
