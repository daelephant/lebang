...
<div class="search" style="float:left;margin-left: 20px;">
         ...
         <div style="float:right;">
            ...
            <?php else: ?>
            <a href="<?php echo U('Quanxian/add');?>" class="btn btn-default0 pull-right">新增后台用户</a><?php endif; ?>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <!-- <td>100</td> -->
                                <td>
                                    <a href="<?php echo U('Quanxian/edit',array('uid'=>$user['id']));?>" class="btn btn-default1" style="width:80px;"  >查看详情</a>
                                    <?php if($user["id"] != 1): ?><a href="<?php echo U('Quanxian/del',array('uid'=>$user['id']));?>" class="btn btn-default2" style="width:50px;" onclick="return confirmAct();" >删除</a><?php endif; ?>
