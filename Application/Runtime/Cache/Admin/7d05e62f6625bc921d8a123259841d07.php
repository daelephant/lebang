    ...
    <!-- <section class="content"> -->
     ...
     {  
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form action="<?php echo U('Msg/add');?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="inputSubject">标&nbsp;&nbsp;题:</label>
                                <input type="text" name="title" placeholder="全民乐帮上线啦" id="inputSubject" class="form-control">
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="brief" placeholder="全民乐帮是由北京亲邻科技有限公司最近推出的一款致力社区服务的软件" id="inputSubject" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">内&nbsp;&nbsp;容:</label>
                                
                                <p><script id="container" name="content" type="text/plain"></script></p>
...
<form action='<?php echo U('User/fetch');?>' method="get">
            ...
            <?php
 $starttime = date('Y-m-d'); $endtime= date('Y-m-d',strtotime('+3 days')); ?>

                <td style="text-align:right">昵称：<input id="name" name="nickname" class="inp_wid3" type="text" value="<?php echo ($_GET['nickname']); ?>"/></td>
                ...
                <td style="text-align:right">查询日期：<input id="starttime" placeholder="填一个即可2016-08-28" name="starttime" class="inp_wid3" type="date" value="<?php echo ($starttime); ?>"/></td>~<input id="endtime"name="endtime" placeholder="2016-08-29" class="inp_wid3" type="date" value="<?php echo ($endtime); ?>"/></td>
                <input class="search_btn1" type="submit" value="搜索" id="Search" />
      </form>
// -->
                        <div class="form-group">
                         <?php
 $starttime = date('Y-m-d'); $endtime= date('Y-m-d',strtotime('+7 days')); ?>
                                <label for="inputSubject">在以下时间段显示此条消息：</label>
                        ...
                        <div class="box-footer clearfix">
                            <button class="btn btn-primary" style ="height:40px; width:335px; margin-left: -10px;"type="submit" id = "submit" name="submit" onclick="return confirmAct();" value="publish">添加</button>
