        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('Shequ/qybianji',['areas_id'=>$areas['id'],'p'=>$_GET['p']]);?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                            ...
                            <div class="form-group">
                                ...
                                <select class="ip"  name="mingcheng" id="shjidizhi" onChange="gzsjdz(this.options[this.options.selectedIndex].value,'shjicity');" >
                                    ...
                                    <?php if(is_array($area)): foreach($area as $k=>$area): if($k == 0): ?><option id='<?php echo ($area['sid']); ?>' value="<?php echo ($area['id']); ?>" selected><?php echo ($area['mingcheng']); ?></option>
                                    <?php else: ?>
                                              <option id='<?php echo ($area['sid']); ?>' value="<?php echo ($area['id']); ?>"><?php echo ($area['mingcheng']); ?></option><?php endif; endforeach; endif; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="ip" type="text" name="quyu" id="inputname" placeholder="请输入区域名称" maxlength="" value="<?php echo ($m_area['mingcheng']); ?>"/>
                                <input type="hidden" name ='id' value = "<?php echo ($m_area['id']); ?>"/>
                            </div>
