...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">Android版</font> 
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Banben/fetch');?>' method="get">
      <input type="text" id="keyword"  class="txt1"  autocomplete="off" name="banbenhao" />
...
<div class="search" style="float:left;margin-left: 20px;">
         ...
         <div style="float:right;">
            <?php if($_GET['banbenhao'] != ''): ?><a href= "javascript:history.back(-1);" class="btn btn-default0 pull-right">返回</a>
            <?php else: ?>
            <a href="<?php echo U('Banben/andadd');?>" class="btn btn-default0 pull-right">新增版本</a><?php endif; ?>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th style="width:650px;">版本说明</th>
                                <th style="width:150px;">团队成员</th>
                                <th style="width:150px;">上线时间</th>
                                <th style="width:150px;">操作</th>
                            
                            </tr>
                          <?php if(is_array($ban)): foreach($ban as $key=>$ban): ?><tr>
                                <td><?php echo ($ban['id']); ?></td>
                                <td><?php echo ($ban['banbenhao']); ?></td>
                                <td style="vertical-align: super;text-align:left;"><?php echo ($ban['shuoming']); ?></td>
                                <td style="text-align:left; font-size:14px;line-height:24px;">
                                  产品: <?php echo ($ban['cname']); ?>
                                  <br>
                                  设计: <?php echo ($ban['sname']); ?>
                                  <br>
                                  研发: <?php echo ($ban['yname']); ?>
                                  <br>
                                  后台: <?php echo ($ban['hname']); ?>
                                  <br>
                                  测试: <?php echo ($ban['shiname']); ?>
                                </td>
                                <td><?php echo date('Y-m-d',$ban['shijian']);?></td>
                              
                                <td >
                                    <a href="<?php echo U('Banben/andedit', ['id'=>$ban['id'],'p'=>$_GET['p']]);?>" class="btn btn-default1" title="编辑" style="width:100px; margin-left:6px;">编辑</a>
                                    <br>
                                    <a href="<?php echo ($ban['app']); ?>" class="btn btn-default1" style="width:100px; margin-top:10px;">下载</a>
