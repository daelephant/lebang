...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">审核未通过用户</font>
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="user_search" action='<?php echo U('User/fetch4');?>' method="get" onsubmit="return checks();">
    ...
    <script type="text/javascript">
                                    ...
                                    //弹出图片src="/lebang11-29/photo/avatar/m_<?php echo ((isset($user['avatar']) && ($user['avatar'] !== ""))?($user['avatar']):"avatar.png"); ?>" 
                                   var arr_img = [
                                        <?php if(is_array($user_list)): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>'/lebang11-29/photo/idpic/<?php echo ((isset($user['idpic']) && ($user['idpic'] !== ""))?($user['idpic']):"avatar.png"); ?>',<?php endforeach; endif; else: echo "" ;endif; ?>
                                    ];
...
        }
                        ...
                        <table  class="table table-bordered">
                            ...
                            <tr >
                               ...
                               <th style="width:80px;">序号</th>  
                                ...
                                <th style="wihdth:100px;">生日</th>
                                <th style="width:180px;">证件号码</th>
                                <th style="width:80px;">证件照</th>
                                <th>备注</th>
                               <!--  <th>性别</th>
                                <th>证件号</th> -->
                            ...
                            <?php if(is_array($user_list)): $k = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($k % 2 );++$k;?><tr>
                               <td><?php echo ($user['id']); ?></td>
                                ...
                                <td><a href="javascript:void(0);" onclick="js_method(<?php echo ($k-1); ?>)"><?php echo ($user['idpic']); ?></td>
    ...
    .cccc{  display:none;  position:fixed;  top:200px; right:350px; margin:auto; text-align:left;   width: 100%; max-width:600px;  height: 300px;  background-color:#F8F8F8;  z-index:6; border-radius:5px;} 
