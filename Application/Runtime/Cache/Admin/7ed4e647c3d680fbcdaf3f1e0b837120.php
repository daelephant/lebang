...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            用户列表
            <a href="<?php echo U('User/add');?>" class="btn btn-default pull-right"><font color="black">添加用户</font></a>
        </h1>
        <!-- <ol class="breadcrumb">
    ...
    <!-- <form action='<?php echo U('User/fetch');?>' method="get">
        <td style="text-align:right">昵称：<input id="name" name="nickname" class="inp_wid3" type="text" value="<?php echo ($_GET['nickname']); ?>"/></td>
                ...
                <td style="text-align:right">查询日期：<input id="starttime" placeholder="填一个即可2016-08-28" name="starttime" class="inp_wid3" type="date" value="<?php echo ($_GET['starttime']); ?>"/></td>~<input id="endtime" name="endtime" placeholder="2016-08-29" class="inp_wid3" type="date" value="<?php echo ($_GET['endtime']); ?>"/></td>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php if(is_array($user_list)): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td style="width: 135px">
                                    <a href="<?php echo U('edit', ['user_id'=>$user['id']]);?>" class="btn btn-default" title=""> <?php echo ($user['status']=='雷锋用户'?'查看':'审核'); ?></a>
                                    <a href="<?php echo U('bianji', ['user_id'=>$user['id']]);?>" class="btn btn-default" title="编辑">编辑</a>
                                    <!-- <a href="<?php echo U('recharge', ['User_id'=>$User['User_id']]);?>" class="btn btn-default" title="充值" onclick="prompt()"> 充值</a> -->
                                   <!--  <form action="<?php echo U('User/recharge');?>" method="post" enctype="multipart/form-data">
                                                     ...
                                                     <button type="submit" value="publish" value="充值"><a href="<?php echo U('recharge', ['user_id'=>$user['id']]);?>">充值</a>充值</button>
                                                   </form> -->
