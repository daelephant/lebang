                    ...
                    <div class="box-body">
                        <table class="table table-bordered" >
                            ...
                            <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($user['groups']); ?></td>  <!-- <td>100</td> -->
                                <td>  
                                    <input type="button" onclick='confirmAct(<?php echo ($user['id']); ?>,<?php echo I('get.p')|1;?>)' class="btn btn-default2" style="width:100px;background: #009900;" value="启用">   
                                </td>
