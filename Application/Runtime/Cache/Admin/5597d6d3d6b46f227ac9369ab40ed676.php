...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            普通用户详情
            <a href="<?php echo U('list');?>" class="btn btn-default0 pull-right">普通用户</a>
        </h1>
        <!-- <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    ...
                    <form action="<?php echo U('User/bianji');?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nickname" id="inputname" maxlength="20" value="<?php echo ($user['nickname']); ?>" /><br />
                                </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="inputSubject">年&nbsp;&nbsp;龄:</label>
                                <input type="text" name="" id="inputname"  maxlength="20" value="<?php echo ($user['age']); ?>" readonly="true"/><br />
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">职&nbsp;&nbsp;业:</label>
                                <input type="text" name="" id="inputidnumber" value="<?php echo ($user['profession']); ?>" maxlength="20" readonly="true"/><br />
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">所在小区:</label>
                                <input type="text" name="" id="inputidnumber" value="<?php echo ($user['shequ']); ?>" maxlength="20" readonly="true"/><br />
                            </div>
                           <div class="form-group">
                                <label for="inputSubject">注册时间:</label>
                                <input type="text" name="" id="inputidnumber" value="<?php echo ($user['regtime']); ?>" maxlength="20" readonly="true" /><br />
                            </div>
                            <div class="form-group">
                                <label for="inputSubject">最后登录:</label>
                                <input type="text" name="" id="inputidnumber" value="<?php echo ($user['logintimes']); ?>" maxlength="20" readonly="true"/><br />
                            </div>
                        ...
                        <div class="boxclearfix">
                           <!--  <a href="<?php echo U('edit', ['user_id'=>$user['id']]);?>" class="btn btn-default" title="编辑"><span class="fa fa-edit"></span> 编辑</a> -->
                            ...
                            <!-- <button class="btn btn-primary0"  type="submit" id = "submit" name="submit" onclick="return confirmAct();" value="publish">禁用</button> -->
...
<script type="text/javascript" src="/lebang13/Public/Admin/js/tinybox.js"></script>
    ...
    <div id="content">
            <div id="images">
                ...
                <img src="/lebang18/photo/avatar/m_<?php echo ((isset($user['avatar']) && ($user['avatar'] !== ""))?($user['avatar']):"avatar.png"); ?>" id="touxiang" style="width:200px;height:200px" />
