        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('pingbik',['xinxianshi_id'=>$xinxianshi['id'],'p'=>$_GET['p']]);?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
...
#tinycontent{background:#ffffff; font-size:1.1em;}
                          ...
                          <div>
                              <div class="form-group" style="float:left; ">
                                ...
                                <input class="ip" type="text" readonly="readonly" name="mingcheng" id="inputPhone" placeholder="" maxlength="11" style="width:240px;background:#f9f9f9;" <?php if(empty($xinxianshi['mingcheng'])): ?>体验小区
                                <?php else: ?>  
                            ...
                            <div class="form-group" style="float:left; position: relative;left: -9px;">
                                <label for="inputCover">发布时间</label>
                                  <input class="ip" type="text" disabled="disabled" name="shijian" id="inputPhone" placeholder="" maxlength="11" style="width:240px;background:#f9f9f9;" value="<?php echo date('Y-m-d H:i:s', $xinxianshi['shijian']);?>">
                            </div>
                         </div>
                            ...
                            <div>
                              <div class="form-group" style="float:left; ">
                                <label for="inputCover">屏蔽理由</label>
                                <input class="ip" type="text" readonly="readonly" name="beizhu" id="inputPhone" placeholder="" maxlength="11" style="width:240px;background:#f9f9f9;" value="<?php echo ($xinxianshi['beizhu']); ?>" />
                            </div>

                            <div class="form-group" style="float:left; position: relative;left: -9px;">
                                <label for="inputCover">屏蔽时间</label>
                                  <input class="ip" type="text" disabled="disabled" name="" id="inputPhone" placeholder="" maxlength="11" style="width:240px;background:#f9f9f9;" value="<?php echo date('Y-m-d H:i:s',$xinxianshi['pingbizhouqi']);?>">
                            </div>
                         </div>
                        ...
                        <div class="boxclearfix">
                           ...
                           <input type="hidden" name="xianshi" id="xianshi" value="<?php echo ($xinxianshi['xianshi']); ?>">
                            <button class="btn btn-primary0"  type="submitx" id = "submit" name="submit" onclick="return confirmAct(1);" value="1" style="width:305px; background:#0099ff;;border:#0099ff;">启用</button>
