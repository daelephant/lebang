...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font">启用小区</font> 
            </div>
        <div class="search" style="floa t:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Shequ/fetch1');?>' method="get" onsubmit="return check()">
      <input type="text" id="text"  class="txt1"  autocomplete="off" name="mingcheng" />
...
<div class="search" style="float:left;margin-left: 20px;">
         ...
         <div style="float:right;">
            <?php if($_GET['mingcheng'] != ''): ?><a href= "javascript:history.back(-1);" class="btn btn-default0 pull-right">返回</a>
            <?php else: ?>
            <a href="<?php echo U('Shequ/add');?>" class="btn btn-default0 pull-right">新增小区</a><?php endif; ?>
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="table table-bordered">
                            <tbody>
                            <tr>
                                <th style="width:80px;"><a href="<?php echo U('started');?>">序号</a></th> 
                                <th style="width:100px;">小区名称</th>
                                <th style="width:70px;">住户</th>
                                <th style="width:70px;">楼栋</th>
                                <th>物业</th>
                                <th style="width:100px;">联系人</th>
                                <th style="width:100px;">联系电话</th>
                                <th style="width:80px;"><a href="<?php echo U('putonglist');?>">普通用户</a></th>
                                <th style="width:80px;"><a href="<?php echo U('leifenglist');?>">雷锋用户</a></th>
                                <th style="width:80px;"><a href="<?php echo U('xinxianshilist');?>">新鲜事</a></th>
                                <th style="width:80px;"><a href="<?php echo U('renwulist');?>">任务</a></th>
                                <th style="width:150px;">操作</th>
                            
                            </tr>
                            <?php if(is_array($shequ_list)): foreach($shequ_list as $key=>$shequ): ?><tr>
                                <td><?php echo ($shequ['id']); ?></td>
                                <td style="text-align:left;"><?php echo ($shequ['mingcheng']); ?></td>
                                <td><?php echo ($shequ['zhuhu']); ?></td>
                                <td><?php echo ($shequ['loudong']); ?></td>
                                <td style="text-align:left;"><?php echo ($shequ['wuye']); ?></td>
                                <td><?php echo ($shequ['lianxiren']); ?></td>
                                <td><?php echo ($shequ['dianhua']); ?></td>
                               
                                <td><?php echo ($shequ['user_num']); ?></td>
                                <td><?php echo ($shequ['user_num2']); ?></td>
                       
                                <td><?php echo ($shequ['xinxianshi_num']); ?></td>
                                <td><?php echo ($shequ['xinxianshi_num2']); ?></td>
                                <td >
                                    <a href="<?php echo U('Shequ/list', ['shequ_id'=>$shequ['id'],'s'=>'started','p'=>$_GET['p']]);?>" class="btn btn-default1" title="编辑">查看详情</a>
