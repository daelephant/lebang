        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('hedit',['id'=>$ban['id'],'p'=>$_GET['p']]);?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
 ...
 <script>
        ...
        document.getElementById('shuomings').value = str;
                          ...
                          <div class="form-group">
                                ...
                                <div name="demand" id="" cols="30" rows="10" style="height:140px;width:558px;position: relative;left:-1px;top: 1px;border:#dddddd solid 1px; resize: none ;color:#666; text-align:left;font-size:16px; float: left;" >
                        ...
                        <div class="form-group" >
                                <label for="inputCover">网址链接</label>
                                <input class="ip" type="text"  name="app" id="inputPhone" placeholder="请输入网址链接" maxlength="" style="width:558px;" value="<?php echo ($ban['app']); ?>"/>
                            </div>
                    ...
                    <div style="clear:both;"></div>
                        <div class="form-group" >
                                ...
                                <input class="ip"  type="text" disabled="true" name="" id="inputPhone" placeholder="" maxlength="" style="width:558px;background:#f9f9f9" value="<?php echo date('Y-m-d',$ban['shijian']);?>"/>
                            </div>
