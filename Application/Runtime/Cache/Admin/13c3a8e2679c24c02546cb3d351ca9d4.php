...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <div>
            ...
            <font class="font" >Android版详情</font>  
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class='left' style='float:left'>
                    <form action="<?php echo U('andedit',['id'=>$ban['id'],'p'=>$_GET['p']]);?>" method="post" enctype="multipart/form-data" onsubmit="return submits();">
 ...
 <script>
        ...
        document.getElementById('shuomings').value = str;
                          ...
                          <div class="form-group">
                                ...
                                <div id="" cols="30" rows="10" style="height:140px;width:558px;position: relative;left:-1px;top: 1px;border:#dddddd solid 1px; resize: none ;color:#666; text-align:left;font-size:16px; float: left;" >

                                    &nbsp;产品:<input type="text"  name="cname" value="<?php echo ($ban['cname']); ?>" style="border:#ffffff solid 1px; "><br>

                                    &nbsp;设计:<input type="text" name="sname" value="<?php echo ($ban['sname']); ?>" style="border:#ffffff solid 1px; "></br>
                                    &nbsp;研发:<input type="text" name="yname" value="<?php echo ($ban['yname']); ?>" style="border:#ffffff solid 1px; "><br>
                                    &nbsp;后端:<input type="text" name="hname" value="<?php echo ($ban['hname']); ?>" style="border:#ffffff solid 1px; "><br>
                                    &nbsp;测试:<input type="text" name="shiname" value="<?php echo ($ban['shiname']); ?>" style="border:#ffffff solid 1px; "><br>
                    ...
                    <div style="clear:both;"></div>
                        <div class="form-group" >
                                ...
                                <input class="ip"  type="text" disabled="true" name="" id="inputPhone" placeholder="" maxlength="11" style="width:558px;background:#f9f9f9" value="<?php echo date('Y-m-d',$ban['shijian']);?>"/>
                            </div>
