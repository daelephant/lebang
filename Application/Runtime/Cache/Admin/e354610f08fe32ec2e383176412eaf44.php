    ...
    <section class="content-header">
      <h1>
        <div>
            ...
            <font class="font" >待开通服务</font>  
            <!-- <p style="width:81px;23px;">待审核用户 </p> -->
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Fuwu/fetchlist1');?>' method="get">
                    ...
                    <div class="box-body">
                         <table class="table table-bordered" >
                            ...
                            <tr style="background: #fbfbfb;">
                                ...
                                <th>项目简介</th>
                                <th style="80px;">单位</th>
                                <th style="80px;">商户数</th>
                                <th style="80px;">预约数</th>
                                <th style="110px;">创建时间</th>
                            ...
                            <?php if(is_array($leibie)): $k = 0; $__LIST__ = $leibie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leibie): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td style="text-align:left;"><?php echo ($leibie['jianjie']); ?></td>
                                ...
                                <td><a href="<?php echo U('chak1', array('id'=>$leibie['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" title="编辑">查看详情</a></td>
