    ...
    <section class="content-header">
      <h1>
        <div>
            ...
            <font class="font" >服务项目</font>  
            <!-- <p style="width:81px;23px;">待审核用户 </p> -->
            </div>
        <div class="search" style="float:left;margin-left: 20px;">
   <form id="shse_search" action='<?php echo U('Fuwu/fetchlist');?>' method="get">
                    ...
                    <div class="box-body">
                         <table class="table table-bordered" >
                            ...
                            <?php if(is_array($leibie)): $k = 0; $__LIST__ = $leibie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leibie): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td><a href="<?php echo U('chak', array('id'=>$leibie['id'],'p'=>$_GET['p']));?>" class="btn btn-default1" title="编辑">查看详情</a></td>
