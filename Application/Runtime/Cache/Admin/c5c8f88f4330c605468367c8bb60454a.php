...
<aside class="right-side">
 ...
 <!--  <script language="javascript">  
     ...
     {  
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form id="myForm" action="<?php echo U('User/edit');?>" method="post">
                    <input type="hidden" name="id" value="<?=$user['id']?>"
                        <div class="box-body">
                        <div class="form-group">
                         <label for="inputSubject"></label>
                            <img src="/lebang13/photo/avatar/<?php echo ((isset($user['avatar']) && ($user['avatar'] !== ""))?($user['avatar']):"avatar.png"); ?>" height="120px;" id="touxiang" style="margin: 7px 0 0 5px" /><br/>
                            </div>
                                <div style="margin-left: 10px" class="form-group">
                            
                                <label for="inputSubject">姓&nbsp;&nbsp;名:</label>
                                <input readonly="true" value="<?php echo ($user['name']); ?>" type="text" name="name" id="inputname"  maxlength="20"  /><br />
                            </div>
                            <div style="margin-left: 10px" class="form-group">
                           
                                <label for="inputSubject">昵&nbsp;&nbsp;称:</label>
                                <input readonly="true" value="<?php echo ($user['nickname']); ?>" type="text" name="nickname" id="inputname"  maxlength="20"  /><br />
                            </div>
                            <div style="margin-left: 10px" class="form-group">
                                <label for="inputCover">用户手机:</label>
                                <input readonly="true" value="<?php echo ($user['phone']); ?>"  type="text" name="phone" id="inputPhone" placeholder="11位手机号" maxlength="11" /><br />
 ...
 $birthday = date('Y-m-d',$user['birthday']); ?> -->
                            ...
                            <div style="margin-left: 10px" class="form-group">
                                ...
                                <input readonly="true" value="<?php echo ($birthday); ?>" type="text" style="height:26px; width:151px;" name="birthday" placeholder="实例格式：1999-10-14" id="inputbirthday" >
                            </div>
                            <div style="margin-left: 10px"class="form-group">
                                <label for="inputSubject">&nbsp;证件号:</label>
                                <input readonly="true" value="<?php echo ($user['idnumber']); ?>"  type="text" name="idnumber" id="inputidnumber" placeholder="max<20位" maxlength="20" /><br />
                            </div>
                            <div style="margin-left: 10px"class="form-group">
                                <label for="inputSubject">备&nbsp;&nbsp;注:</label>
                                <input value="<?php echo ($user['beizhu']); ?>"  type="text" name="beizhu" id="inputidnumber" placeholder="请填写备注信息" /><br />
                            </div>
                           
                            <div style="margin-left: 10px"class="form-group">
                             <label for="inputSubject">&nbsp;证件照:</label>
                             </div>
                            
                            <img src="/lebang13/photo/idpic/<?php echo ((isset($user['idpic']) && ($user['idpic'] !== ""))?($user['idpic']):"idpic.png"); ?>" style="margin-left: 10px;margin-top: -15px;"/>
                            <img src="/lebang13/photo/idpic/<?php echo ((isset($user['idpic']) && ($user['idpic'] !== ""))?($user['idpic']):"idpic.png"); ?>"style="margin-top: -15px;"/><br/>
 
                    <?php if($user['status'] != '3'): ?><button class="btn btn-primary" type="submit" style="margin-left: 10px;width:100px;" id = "submit" name="status" value="3">通过</button>
                    <button class="btn btn-primary" type="submit" style= "height:33px; width:100px;" id = "submit" name="status" value="4">不通过</button>  
                    <?php else: endif; ?>
</form>
