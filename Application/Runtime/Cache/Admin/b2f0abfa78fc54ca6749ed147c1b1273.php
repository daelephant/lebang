...
<aside class="right-side">
   ...
   <form id="user_search" action='<?php echo U('Xinxianshi/fetch');?>' method="get">
                    ...
                    <div class="box-body">
                         <table class="table table-bordered" >
                            ...
                            <tr style="background: #fbfbfb;">
                                ...
                                <!-- <th>状态</th> -->
                                <th style="width:80px"><a href="<?php echo U('dianzhanlist');?>">点赞</th>
                                <!-- <th>状态</th> -->

                                <th style="width:80px"><a href="<?php echo U('pinglunlist');?>">评论</th>
